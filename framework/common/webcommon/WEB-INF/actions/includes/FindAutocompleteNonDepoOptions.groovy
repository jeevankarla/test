...
if (orExprs && entityName && displayFieldsSet) {
	...
	if (autocompleteOptions) {
		...
		autocompleteOptions = EntityUtil.filterByCondition(autocompleteOptions, EntityCondition.makeCondition("partyId", EntityOperator.NOT_IN, facilityDepoList.ownerPartyId));

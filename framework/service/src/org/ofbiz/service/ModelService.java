    ...
    */
    ...
    public void getWSDL(Definition def, String locationURI) throws WSDLException {
        ...
        if (inParam != null) {
            ...
            Element tenantAttr = document.createElement("attribute");
            tenantAttr.setAttribute("name", "tenantId");
            tenantAttr.setAttribute("type", "std-String");
            tenantAttr.setAttribute("namespace", TNS);
            tenantAttr.setAttribute("java-class", String.class.getName());
            tenantAttr.setAttribute("optional", Boolean.toString(false));
            documentation.appendChild(tenantAttr);

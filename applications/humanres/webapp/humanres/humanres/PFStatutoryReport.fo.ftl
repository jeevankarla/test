   			...
   			<fo:page-sequence master-reference="main">
		        <fo:static-content flow-name="xsl-region-before">
					...
					<fo:block font-weight="bold" keep-together="always" font-size="12pt" text-align="right" font-family="Courier,monospace"> Page No: <fo:page-number/> &#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</fo:block>
		  			<fo:block font-weight="bold" keep-together="always" font-size="12pt" text-align="right" font-family="Courier,monospace">Monthly Statement of Employees Provident Fund &#160;: ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(nowTimestamp, "MMMM-yyyy")}&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Date : ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(nowTimestamp, "dd-MMM-yyyy")}&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;</fo:block>
						...
						<fo:table table-layout="fixed" width="50%" >
							...
							<fo:table-body >
								...
								<#list employeeMap as employeeMapvalues>
									<#assign employeeTotal=	employeeMapvalues.getValue().get("EmployeesMap").get("epf")?if_exists+employeeMapvalues.getValue().get("EmployeesMap").get("fpf")?if_exists>	
									<#assign employerTotal=	employeeMapvalues.getValue().get("EmployersMap").get("employerEpf")?if_exists+employeeMapvalues.getValue().get("EmployersMap").get("employerFpf")?if_exists>
								 	<fo:table-row font-size="10pt">	
										...
										<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right"> ${employeeMapvalues.getValue().get("EmployeesMap").get("epf")?string("0.##")?if_exists} </fo:block></fo:table-cell>
										...
										<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${employeeMapvalues.getValue().get("EmployersMap").get("employerVpf")?if_exists}</fo:block></fo:table-cell>
								        ...
								        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${employeeTotal?string("0.##")}</fo:block></fo:table-cell>						
								        ...
								        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${employeeMapvalues.getValue().get("EmployersMap").get("employerEpf")?string("0.##")?if_exists}</fo:block></fo:table-cell>						
								        ...
								        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${employeeMapvalues.getValue().get("EmployersMap").get("employerFpf")?string("0.##")?if_exists}</fo:block></fo:table-cell>
										...
										<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${employerTotal?string("0.##")} </fo:block></fo:table-cell>
								        ...
								        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right">${(employeeTotal+employerTotal)?string("0.##")}</fo:block></fo:table-cell>
									...
									<#if (noOfLines == 36)>
			                 			...
			                 			<fo:table-row font-size="10pt">
											...
											<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="center">&#160; </fo:block></fo:table-cell>
											<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="center">&#160; </fo:block></fo:table-cell>
									        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageEmplwage?string("0.##")?if_exists}</fo:block></fo:table-cell>
											<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold"> ${pageEmplepf?string("0.##")?if_exists} </fo:block></fo:table-cell>
											<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageemployerVpf?if_exists}</fo:block></fo:table-cell> 
									        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageemployeeTotal?string("0.##")}</fo:block></fo:table-cell>						
											<fo:table-cell><fo:block keep-together="always" text-align="right"> </fo:block></fo:table-cell>
									        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageemployerEpf?string("0.##")?if_exists}</fo:block></fo:table-cell>						
									        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageemployerFpf?string("0.##")?if_exists}</fo:block></fo:table-cell>
											<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${pageemployerTotal?string("0.##")} </fo:block></fo:table-cell>
									        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${(pageemployeeTotal+pageemployerTotal)?string("0.##")}</fo:block></fo:table-cell>
								        </fo:table-row>
				                 		<#assign pageEmplwage=0>
				                 		<#assign pageEmplepf=0>
								...
								<fo:table-row font-size="10pt">	
									...
									<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="center">&#160; </fo:block></fo:table-cell>
							        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totEmplwage?string("0.##")?if_exists}</fo:block></fo:table-cell>
									<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold"> ${totEmplepf?string("0.##")?if_exists} </fo:block></fo:table-cell>
									<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totemployerVpf?if_exists}</fo:block></fo:table-cell>
							        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totemployeeTotal?string("0.##")}</fo:block></fo:table-cell>						
									<fo:table-cell><fo:block keep-together="always" text-align="right"> </fo:block></fo:table-cell>
							        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totemployerEpf?string("0.##")?if_exists}</fo:block></fo:table-cell>						
							        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totemployerFpf?string("0.##")?if_exists}</fo:block></fo:table-cell>
									<fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${totemployerTotal?string("0.##")} </fo:block></fo:table-cell>
							        <fo:table-cell border-style="solid"><fo:block keep-together="always" text-align="right" font-weight="bold">${(totemployeeTotal+totemployerTotal)?string("0.##")}</fo:block></fo:table-cell>
						        </fo:table-row>
							</fo:table-body>
						</fo:table>  
		  			</fo:block>

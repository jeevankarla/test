...
<script type="application/javascript">
	...
	function setupGrid2() {
		    var columns = [
					{id:"inputTypeId", name:"Input", field:"inputTypeId", width:220, minWidth:220,  cssClass:"readOnlyColumnClass",regexMatcher:"contains",  sortable:false, toolTip:""},
					{id:"grossAmount", name:"Gross Amount", field:"grossAmount", width:100, minWidth:100, cssClass:"readOnlyColumnClass", sortable:false, focusable :false,},
					{id:"qualifyingAmount", name:"Qualifying Amount", field:"qualifyingAmount", width:100, minWidth:100, cssClass:"cell-title",editor:FloatCellEditor,cssClass:"readOnlyColumnClass", sortable:false},
					{id:"deductableAmount", name:"Deductable Amount / Actual Amount", field:"deductableAmount", width:100, minWidth:100, cssClass:"readOnlyColumnClass", focusable :false,editor:FloatCellEditor, sortable:false}
			];
			var options = {
			editable: true,		
		...
		//}
         grid2.onKeyDown.subscribe(function(e) {
			...
			if(e.which == $.ui.keyCode.UP && cell.row == 0){
				...
				grid2.getEditController().commitCurrentEdit();
				grid2.gotoCell(data.length, 0, true);
				$(grid2.getCellNode(data.length, 0)).edit();
	...
	jQuery(function(){
    	...
    	var rowCount = jQuery('#myGrid2 .slick-row').length;
		if (rowCount > 0) {			
			$(mainGrid2.getCellNode(rowCount-1, 0)).click();		   
    	}
    	else { 
			$("#orderId").focus();      
		}  		

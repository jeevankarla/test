  ...
  return (x == y ? 0 : (x > y ? 1 : -1));
	...
	function setUpItemList() {
			...
			var columns = [		
					...
					{id:"noOfPayableDays", name:"No of payable Days", field:"noOfPayableDays", width:140, minWidth:100, cssClass:"cell-title", sortable:true, editor:FloatCellEditor},
			];
...
<div id="div2" style="float: left;width: 100%;align:right; border: #F97103 solid 0.1em;">
    ...
    <div>    	
 		<div class="grid-header" style="width:100%">
			<font size="15" color="#22047F"><b>Employee Leave Encashment <b/></font>:<font size="15" color="red"><b><#if timePeriodStart?has_content>[${(Static["org.ofbiz.base.util.UtilDateTime"].toDateString(timePeriodStart?if_exists, "MMMMM-yyyy"))}]</#if></b></font>
		</div>    

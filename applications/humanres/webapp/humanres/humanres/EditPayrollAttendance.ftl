  ...
  return (x == y ? 0 : (x > y ? 1 : -1));
	...
	function setUpItemList() {
			...
			var columns = [		
					...
					{id:"noOfLeaveDays", name:"Leave Days", field:"noOfLeaveDays", width:85, minWidth:100, cssClass:"cell-title", sortable:true, editor:FloatCellEditor},
					...
					{id:"lossOfPayDays", name:"LOP Days", field:"lossOfPayDays", width:75, minWidth:100, cssClass:"cell-title", sortable:true, editor:FloatCellEditor},

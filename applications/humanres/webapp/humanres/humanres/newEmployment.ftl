...
<script type="application/javascript">
	...
	function newEmployment(partyId) {
		...
		message +=  "<tr class='h3'><td align='left' class='h3' width='60%'>Employee Id :</td><td align='left' width='60%'><input class='h4' type='text' readonly id='partyIdTo' name='partyIdTo' value='${partyId?if_exists}'/></td></tr>";

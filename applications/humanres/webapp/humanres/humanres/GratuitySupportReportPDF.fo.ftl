			...
			<fo:page-sequence master-reference="main">
						...
						<fo:table-body>
						 <fo:table-row height="14px" space-start=".15in" text-align="center">
								   <fo:table-cell number-columns-spanned="1" border-style="solid" width="40px">
									...
									<fo:table-cell number-columns-spanned="1" border-style="solid" width="65px">
				...
				<fo:flow flow-name="xsl-region-body" font-family="Courier,monospace">
					...
					<fo:table>
	                    ...
	                    <fo:table-cell number-columns-spanned="1" border-style="solid" width="65px">
	                    	<fo:block text-align="center" keep-together="always">${employee.get("employeeId")?if_exists}</fo:block>
	                    </fo:table-cell>
	                    <fo:table-cell number-columns-spanned="1" border-style="solid" width="200px">
	                    ...
	                    <fo:table-cell number-columns-spanned="1" border-style="solid" width="120px">
	                    	<fo:block text-align="center" keep-together="always">${employee.get("birthDate")?if_exists?upper_case}</fo:block>
	                    </fo:table-cell>
	                    <fo:table-cell number-columns-spanned="1" border-style="solid" width="130px">

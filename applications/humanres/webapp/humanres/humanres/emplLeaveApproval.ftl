...
function cancelForm(){                 
	...
	function showLeaveApprovalQTip(emplLeaveApplId) {
		...
		message +=  "<tr class='h3'><td align='left' class='h3' width='50%'>Employee ID :</td><td align='left' width='50%'><input class='h4' type='text' readonly id='partyName' name='partyName' value='"+partyId+""+"("+""+partyName+""+")"+"'/></td></tr>"+
					"<tr class='h3'><td align='left' class='h3' width='50%'>Approver ID:</td><td align='left' width='50%'><input class='h4' type='text' readonly id='approverPartyId' name='approverPartyId' value='"+approverPartyId+"'/></td></tr>"+
					...
					"<tr class='h3'><td align='left' class='h3' width='50%'>Leave Reason :</td><td align='left' width='50%'><input class='h4' type='text' readonly id='emplLeaveReasonTypeId' name='emplLeaveReasonTypeId' value='"+emplLeaveReasonTypeId+"'/></td></tr>"+
					"<tr class='h3'><td align='left' class='label h3' width='50%' style='text-align:left'>Description:</td><td align='left' width='50%'><textarea rows='4' class='h4' type='text' readonly id='description' name='description' value='"+description+"'>"+description+"</textarea><input class='h4' type='hidden' readonly id='emplLeaveApplId' name='emplLeaveApplId' value='"+emplLeaveApplId+"'/><input class='h4' type='hidden' readonly id='partyId' name='partyId' value='"+partyId+"'/></td></tr>"+
					...
					"<tr class='h3'><td align='left' class='h3' width='50%'>To Date:</td><td align='left' width='50%'><input class='h4' type='text' readonly id='thruDate' name='thruDate' value='"+thruDate+"'<#if (leaveStatus?has_content && leaveStatus == "LEAVE_APPROVED") && security.hasEntityPermission("APPROVED_LEAVE", "_UPDATE", session)> onmouseover='picker()'</#if>/></td></tr>"+
					"<tr class='h3'><td align='left' class='h3' width='50%'>Comp Off Days:</td><td align='left' width='50%'><input class='h4' type='text' readonly id='dateList' name='dateList' value='"+dateList+"'/></td></tr>";

...
<script type="application/javascript">
	...
	function setupGrid2() {
		    var columns = [
					{id:"totalIncomeFrom", name:"Total Income From", field:"totalIncomeFrom", width:120, minWidth:220,  cssClass:"readOnlyColumnClass",regexMatcher:"contains",  sortable:false, toolTip:""},
					{id:"totalIncomeTo", name:"Total Income To", field:"totalIncomeTo", width:120, minWidth:100, cssClass:"readOnlyColumnClass", sortable:false, focusable :false,},
					{id:"taxPercentage", name:"Tax Percentage", field:"taxPercentage", width:120, minWidth:100, cssClass:"cell-title",editor:FloatCellEditor,cssClass:"readOnlyColumnClass", sortable:false},
					{id:"addedAmount", name:"Slab Amount", field:"addedAmount", width:120, minWidth:100, cssClass:"readOnlyColumnClass", focusable :false,editor:FloatCellEditor, sortable:false}
			];
			var options = {
			editable: true,		

				   ...
				   <tr class="alternate-row">
						<form id="CashEncashmentReport" name="CashEncashmentReport" mothed="post" action="<@ofbizUrl>CashEncashmentReport.pdf</@ofbizUrl>" target="_blank">
							<table class="basic-table" cellspacing="5">	
								<tr class="alternate-row">
									<td width="15%"><span class='h3'>Cash Encashment Report</span></td>
									...
									<input type="hidden" name="deptId" class="commonPartyId" value ="Company">
									<input  type="hidden"  id="employeeId"   name="employeeId" value = "${parameters.partyId}"/>
									<span class='h3'><input type="submit" value="PDF" onClick="javascript:appendParams('CashEncashmentReport', '<@ofbizUrl>CashEncashmentReport.pdf</@ofbizUrl>');" class="buttontext"/></span></td>
								</tr>
							</table>
						</form>
				   	</tr>

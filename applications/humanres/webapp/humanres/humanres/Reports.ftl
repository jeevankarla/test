...
<#if reportFrequencyFlag =="MastersReports">
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeesListCsv.csv"))?exists && (reportDetailsMap.get(tenantId).get("EmployeesListCsv.csv") == "Y"))> 
							<tr class="alternate-row"> 
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeeProfilePdf.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EmployeeProfilePdf.pdf") == "Y"))> 
							<tr class="alternate-row"> 
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("LICRDReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("LICRDReport.pdf") == "Y"))> 
							<tr class="alternate-row"> 
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("LeaveAvailedReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("LeaveAvailedReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("CashEncashmentReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("CashEncashmentReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("GHSSDepatmentCountReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("GHSSDepatmentCountReport.pdf") == "Y"))> 
							<tr class="alternate-row">
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("MonthlyAttendenceChecklist.pdf"))?exists && (reportDetailsMap.get(tenantId).get("MonthlyAttendenceChecklist.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeeMisPunchData.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EmployeeMisPunchData.pdf") == "Y"))> 
							<tr class="alternate-row">
					 ...
					 <#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeePunchData.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EmployeePunchData.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("DayWiseEditedLateHoursReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("DayWiseEditedLateHoursReport.pdf") == "Y"))> 
							<tr class="alternate-row">
								<table class="basic-table" cellspacing="3">
									<form id="DayWiseEditedLateHoursReport" name="DayWiseEditedLateHoursReport" mothed="post" action="<@ofbizUrl>DayWiseEditedLateHoursReport.pdf</@ofbizUrl>" target="_blank">
										<table class="basic-table" cellspacing="5">
											<tr class="alternate-row">
												<td width="13%"><span class='h3'>Day Wise Edited Late Hours Report</span></td>
												<td width="22%"><span class='h3'>Period Id</span>
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ConsolidatedEditedLateHoursReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ConsolidatedEditedLateHoursReport.pdf") == "Y"))> 
							<tr class="alternate-row">
								<table class="basic-table" cellspacing="3">
									<form id="ConsolidatedEditedLateHoursReport" name="ConsolidatedEditedLateHoursReport" mothed="post" action="<@ofbizUrl>ConsolidatedEditedLateHoursReport.pdf</@ofbizUrl>" target="_blank">
										<table class="basic-table" cellspacing="5">
											<tr class="alternate-row">
												<td width="13%"><span class='h3'>Consolidated Edited Late Hours Report</span></td>
												<td width="22%"><span class='h3'>Period Id</span>
													<select name="customTimePeriodId" class='h4'>
														<#list timePeriodList as timePeriod>    
															<option value='${timePeriod.customTimePeriodId}'>${timePeriod.periodName?if_exists}:${timePeriod.fromDate?if_exists}-${timePeriod.thruDate?if_exists}</option>
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeesLOPdays.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EmployeesLOPdays.pdf") == "Y"))> 
							<tr class="alternate-row">
				 ...
				 <!-- 	<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("AttendanceExceptionReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("AttendanceExceptionReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("BusArrivalReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("BusArrivalReport.pdf") == "Y"))> 
							<tr class="alternate-row">
      	  			...
      	  			<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("OODReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("OODReport.pdf") == "Y"))> 
							<tr class="alternate-row">
      	  			...
      	  			<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PayableDaysReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PayableDaysReport.pdf") == "Y"))> 
							<tr class="alternate-row">
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
				<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PayrollExceptionReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PayrollExceptionReport.pdf") == "Y"))> 
							<tr class="alternate-row">
				   ...
				   <#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeeBankDetailsPdf.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EmployeeBankDetailsPdf.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("MonthlyBankStatement.pdf"))?exists && (reportDetailsMap.get(tenantId).get("MonthlyBankStatement.pdf") == "Y"))> 
							<tr class="alternate-row">
				   ...
				   <#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EcsBankDetailsCsv.csv"))?exists && (reportDetailsMap.get(tenantId).get("EcsBankDetailsCsv.csv") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PrintPaySlipsPdf.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PrintPaySlipsPdf.pdf") == "Y"))> 
							<tr class="alternate-row">	
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PrePrintedpaySlip.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PrePrintedpaySlip.pdf") == "Y"))> 
						   	<tr class="alternate-row">
				   	...
				   	<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("CanteenReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("CanteenReport.pdf") == "Y"))> 
						   	<tr class="alternate-row">
								<table class="basic-table" cellspacing="3">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("IncrementCertificate.pdf"))?exists && (reportDetailsMap.get(tenantId).get("IncrementCertificate.pdf") == "Y"))> 
						   	<tr class="alternate-row"> 
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("DepartmentTotalsReport.txt"))?exists && (reportDetailsMap.get(tenantId).get("DepartmentTotalsReport.txt") == "Y"))> 
							<tr class="alternate-row">
				   	...
				   	<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("IncomeTaxReport.txt"))?exists && (reportDetailsMap.get(tenantId).get("IncomeTaxReport.txt") == "Y"))> 
							<tr class="alternate-row">
				   ...
				   <#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("CostCodeReport.txt"))?exists && (reportDetailsMap.get(tenantId).get("CostCodeReport.txt") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EmployeeWiseSalaryDetails"))?exists && (reportDetailsMap.get(tenantId).get("EmployeeWiseSalaryDetails") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("DeductionsReport.txt"))?exists && (reportDetailsMap.get(tenantId).get("DeductionsReport.txt") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("BenefitReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("BenefitReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PayrollConsolidatedSummaryReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PayrollConsolidatedSummaryReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ExportEmployeeBenefitsOrDeductions"))?exists && (reportDetailsMap.get(tenantId).get("ExportEmployeeBenefitsOrDeductions") == "Y"))> 
							<tr class="alternate-row">
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ITEarningsReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ITEarningsReport.pdf") == "Y"))> 
						   <tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("PFMonthlyStatement.pdf"))?exists && (reportDetailsMap.get(tenantId).get("PFMonthlyStatement.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ITAXStatement.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ITAXStatement.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ESIMonthlystatement.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ESIMonthlystatement.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ITAXQuarterlyStatementCsv.csv"))?exists && (reportDetailsMap.get(tenantId).get("ITAXQuarterlyStatementCsv.csv") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ESIFormSix.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ESIFormSix.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("ESIFormSeven.pdf"))?exists && (reportDetailsMap.get(tenantId).get("ESIFormSeven.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("GratuitySupportReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("GratuitySupportReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("EDLISReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("EDLISReport.pdf") == "Y"))> 
							<tr class="alternate-row">
					...
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("GSLISReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("GSLISReport.pdf") == "Y"))> 
							<tr class="alternate-row"> 
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("LeaveEncashmentReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("LeaveEncashmentReport.pdf") == "Y"))> 
							<tr class="alternate-row">
	...
	<div>
		<div class="screenlet">
			...
			<div class="screenlet-body">
				<table class="basic-table hover-bar h3" style="border-spacing: 0 10px;">
					<#if (reportDetailsMap.get(tenantId)?has_content)>
						<#if ((reportDetailsMap.get(tenantId).get("loanTypeReport.pdf"))?exists && (reportDetailsMap.get(tenantId).get("loanTypeReport.pdf") == "Y"))> 
							<tr class="alternate-row">

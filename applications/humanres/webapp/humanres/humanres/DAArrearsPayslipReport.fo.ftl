...
<fo:page-sequence master-reference="main" font-family="Courier,monospace"  force-page-count="no-force">					
		<fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace"> 
            ...
            <#assign designation = delegator.findOne("EmplPositionType", {"emplPositionTypeId" : emplPositionAndFulfilment[0].emplPositionTypeId?if_exists}, true)>
          	<fo:block text-align="center" white-space-collapse="false" font-weight="bold"> DA ARREARS FOR THE PERIOD OF  From: To : </fo:block>
          	<fo:block text-align="left" white-space-collapse="false" font-weight="bold">SEC:                   &#160;&#160;EMPLOYEE:${partyBenefitsMap.getKey()}                     BANK A/C NO:911010023964008</fo:block>
		                 ...
		                 <fo:table-row >  
	                       ...
	                       <fo:block>---------------------------------------------------------------------------------------------</fo:block>
 							...
 							<#assign employeeamountList=employeeamountMap.entrySet()>
										...
										<#assign netDATotal=0>
 										 ...
 										 <#assign monthKey = employeeDetails.getKey()>
											...
											<fo:table-row font-weight= "bold">
						                        ...
						                        <fo:table-cell>
						                          <fo:block text-align="right"  >${netDATotal?if_exists?string("#0.00")}</fo:block>
						                        </fo:table-cell>
						                         <fo:table-cell>
						                          <fo:block text-align="right"  >0.00</fo:block>
						                        </fo:table-cell>
			                       ...
			                       <fo:table-row>
			                        <fo:table-cell>
			                          <fo:block text-align="center"  font-weight="bold" >PTAX  = 0.00 </fo:block>
			                          <fo:block text-align="center"  font-weight="bold" >ESI   = 0.00</fo:block>
			                          <fo:block text-align="center"  font-weight="bold" >EPP    = ${(0.12*netDATotal)?if_exists?string("#0.00")}</fo:block>
			                          <fo:block text-align="center"  font-weight="bold" >NSC   = 0.00 </fo:block>

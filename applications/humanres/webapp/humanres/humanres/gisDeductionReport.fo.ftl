...
<#escape x as x?xml>
  <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<#else>
	<#if GisdetailsMap?has_content>
 		<#assign HeaderDetailsList=GisdetailsMap.entrySet()>
	     					...
	     					<fo:table-body>
       						...
       						<#assign emplPositionAndFulfilment=delegator.findByAnd("EmplPositionAndFulfillment", {"employeePartyId" : employDetails.get("employeeId")})/>
       							<fo:table-row>
       								...
       								<fo:table-cell><fo:block keep-together="always" font-size="4pt" text-align="left">${employDetails.get("employeeId")}</fo:block></fo:table-cell>
       								<fo:table-cell><fo:block keep-together="always" font-size="4pt" text-align="left">${Static["org.ofbiz.order.order.OrderServices"].nameTrim((StringUtil.wrapString(Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, employDetails.get("employeeId"), false))),20)}</fo:block></fo:table-cell>

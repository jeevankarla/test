...
<input type="hidden" id="prevFlag" name="prevFlag" value="${prevFlag}" />
<input type="hidden" id="nextFlag" name="nextFlag" value="${nextFlag}" />
...
<script src="/partymgr/static/hrCalender.js" type="text/javascript"></script>

...
if (productionRunId) {
    ...
    if (productionRun.exist()) {
        ...
        productionRunRoutingTasks.each { prodRunTask ->
            taskFixedAssets = delegator.findByAnd("WorkEffortAndFixedAssetAssign", [workEffortId : prodRunTask.workEffortId]); //prodRunTask.getRelated("WorkEffortFixedAssetAssign");

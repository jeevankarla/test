...
public class LoginEvents {
    ...
    public static String emailPassword(HttpServletRequest request, HttpServletResponse response) {
        ...
        // if a tenantId was passed in, see if the username is associated with that tenantId (can use any delegator for this, entity is not tenant-specific)
            ...
            if (delegatorNameHashIndex == -1 || (currentDelegatorTenantId != null && !tenantId.equals(currentDelegatorTenantId))) {
                ...
                */
                ...
                try {
                    ...
                    String errMsg = UtilProperties.getMessage(resource, "loginevents.error_accessing_password", messageMap, UtilHttp.getLocale(request));
                    request.setAttribute("_ERROR_MESSAGE_", errMsg);
                    return "error";
                }
            }
        ...
        serviceContext.put("subject", "forgot password request for " + userLoginId);

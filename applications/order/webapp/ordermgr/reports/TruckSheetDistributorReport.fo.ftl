			              						...
			              						<fo:table-body>                  						 
						                            ...
						                            <fo:table-cell>
						                                ...
						                                <fo:block linefeed-treatment="preserve">&#xA;</fo:block> 
						                      			...
						                      			<#if (typeEntry.getKey() != "AGNTCS") && (typeEntry.getKey() != "PTCCS") && (typeEntry.getKey() != "LITRES") && (typeEntry.getKey() != "TOTALAMOUNT") && typeEntry.getKey() != "NOPKTS" && typeEntry.getKey() != "NOCRATES"> 
						                      			   <fo:table-cell >

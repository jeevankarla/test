...
<script type="application/javascript">   
  ...
  var data = [
<#list productReportList as productReport>
    {label: "${StringUtil.wrapString(productReport.name?default(""))}", data: ${productReport.totalRevenue?if_exists}}<#if productReport_has_next>,</#if>
</#list>    
  ];
  ...
  var data2 = [
<#list zoneReportList as zoneReport>
    {label: "${StringUtil.wrapString(zoneReport.name?default(""))}", data: ${zoneReport.totalRevenue?if_exists}}<#if zoneReport_has_next>,</#if>
</#list>    
  ];            
  ...
  var data3 = [
<#list supplyTypeReportList as supplyTypeReport>
    {label: "${StringUtil.wrapString(supplyTypeReport.name?default(""))}", data: ${supplyTypeReport.totalRevenue?if_exists}}<#if supplyTypeReport_has_next>,</#if>
</#list>    
  ];            
...
<div class="screenlet">
    <div class="screenlet-title-bar">
      <h3>Product-wise Sales Revenue for ${salesDate?date}</h3>
    </div>
    <div class="screenlet-body">
   		<div id="chart" class="graph"></div>
   		<br><br>
  
		<div id="myGrid1" style="width:200px;height:400px"></div>   		
    </div>
</div>
<div class="screenlet">
    <div class="screenlet-title-bar">
      <h3>Supply Type-wise Sales Revenue for ${salesDate?date}</h3>
    </div>
    <div class="screenlet-body">
   		<div id="chart3" class="graph"></div>
   		<br><br>
		<div id="myGrid3" style="width:250px;height:300px"></div>   		  
    </div>
</div>
</div>
...
<div class="screenlet">
    <div class="screenlet-title-bar">
      <h3>Zone-wise Sales Revenue for ${salesDate?date}</h3>
    </div>
    <div class="screenlet-body">
   		<div id="chart2" class="graph"></div>
   		<br><br>
   
		<div id="myGrid2" style="width:270px;height:400px"></div>     		
    </div>
</div>
</div>
<#else>

   ...
   public static Map<String, Object> createCustPaymentFromPreference(DispatchContext dctx, Map<String, ? extends Object> context) {
       ...
       try {
           ...
           if (payToPartyId != null) {
        	   ...
        	   conditionList.add(EntityCondition.makeCondition("fromDate", EntityOperator.LESS_THAN_EQUAL_TO, UtilDateTime.getDayEnd(orderDate)));
   			   conditionList.add(EntityCondition.makeCondition(EntityCondition.makeCondition("thruDate", EntityOperator.EQUALS, null), EntityOperator.OR, 
   					EntityCondition.makeCondition("thruDate", EntityOperator.GREATER_THAN_EQUAL_TO, UtilDateTime.getDayStart(orderDate))));
        	   EntityCondition condition = EntityCondition.makeCondition(conditionList, EntityOperator.AND);  	
        	   try{

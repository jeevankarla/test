...
public class ShoppingCart implements Iterable<ShoppingCartItem>, Serializable {
    ...
    protected Timestamp estimatedDeliveryDate = null;
    ...
    public String getProductSubscriptionTypeId() {
        return this.productSubscriptionTypeId;
    }

    public void setProductSubscriptionTypeId(String productSubscriptionTypeId) {
        this.productSubscriptionTypeId = productSubscriptionTypeId;
    }
    ...
    public void setEstimatedDeliveryDate(Timestamp t) {
        this.estimatedDeliveryDate = t;
    }
...
//    protected String billFromVendorPartyId = null;
  //  protected String shipFromVendorPartyId = null;
    ...
    public int addOrderTerm(String termTypeId, String orderItemSeqId,BigDecimal termValue, Long termDays, String textValue, String uomId, String description) {
        GenericValue orderTerm = this.getDelegator().makeValue("OrderTerm");
        orderTerm.put("termTypeId", termTypeId);
        if (UtilValidate.isEmpty(orderItemSeqId)) {
        	orderItemSeqId = "_NA_";
    ...
    public List<GenericValue> makeOrderItems(boolean explodeItems, boolean replaceAggregatedId, LocalDispatcher dispatcher) {
        ...
        synchronized (cartLines) {
            ...
            for (ShoppingCartItem item : cartLines) {
                ...
                orderItem.set("fat", item.getFat());
                orderItem.set("snf", item.getSnf());              
                orderItem.set("lactoReading", item.getLactoReading());
                orderItem.set("createdDate", UtilDateTime.nowTimestamp());
                orderItem.set("createdByUserLoginId", this.getUserLogin().get("userLoginId"));
                orderItem.set("estimatedDeliveryDate", item.getEstimatedDeliveryDate());
                orderItem.set("unitPremiumPrice", item.getUnitPremiumPrice()); 
                orderItem.set("sQuantityLtrs", item.getSQuantityLtrs());                
                orderItem.set("sFat", item.getSFat());
                orderItem.set("sUnitPrice", item.getSUnitPrice());
                orderItem.set("quantityKgs", item.getQuantityKgs());
                orderItem.set("quantityLtrs", item.getQuantityLtrs());
                orderItem.set("cQuantityLtrs", item.getCQuantityLtrs());                
                orderItem.set("supplyTypeEnumId", item.getSupplyTypeEnumId());
    ...
    public Map<String, Object> makeCartMapSimpleLMSOrder(LocalDispatcher dispatcher, boolean explodeItems) {

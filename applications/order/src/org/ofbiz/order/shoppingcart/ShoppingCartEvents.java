...
public class ShoppingCartEvents {
    ...
    /**
     * set the estimated delivery date for the cart based on request.  right now will always return "success"
     *
     */
    public static String setEstimatedDeliveryDate(HttpServletRequest request, HttpServletResponse response) {
        ShoppingCart cart = getCartObject(request);
        String estimatedDeliveryDateStr = request.getParameter("estimatedDeliveryDate");
        cart.setEstimatedDeliveryDate(java.sql.Timestamp.valueOf(estimatedDeliveryDateStr));
        return "success";
    }    

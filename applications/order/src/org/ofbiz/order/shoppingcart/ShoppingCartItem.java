...
public class ShoppingCartItem implements java.io.Serializable {
    ...
    private String supplyTypeEnumId = null;
    private BigDecimal unitPremiumPrice = null;
    
    private BigDecimal sQuantityLtrs = null;
    private BigDecimal sFat = null;
    private BigDecimal sUnitPrice = null;
    private BigDecimal cQuantityLtrs = null;
    private BigDecimal quantityKgs = null;
    private BigDecimal quantityLtrs = null;
    private BigDecimal lactoReading = null;
    
    private BigDecimal vatPercent = null;
    private BigDecimal vatAmount = null;
    private BigDecimal bedPercent = null;
    private BigDecimal bedAmount = null;
    private BigDecimal bedcessPercent = null;
    ...
    */
    ...
    public ShoppingCartItem(ShoppingCartItem item) {
        ...
        this.lactoReading = item.getLactoReading();
        ...
        this.snf = item.getSnf();
        this.fat = item.getFat();       
        this.estimatedDeliveryDate = item.getEstimatedDeliveryDate();
        this.supplyTypeEnumId = item.getSupplyTypeEnumId();
        this.unitPremiumPrice = item.getUnitPremiumPrice();
        this.sQuantityLtrs = item.getSQuantityLtrs();
        this.sFat = item.getSFat();
        this.sUnitPrice = item.getSUnitPrice();
        this.cQuantityLtrs = item.getCQuantityLtrs();
        this.quantityKgs = item.getQuantityKgs();
        this.quantityLtrs = item.getQuantityLtrs();
    ...
    protected ShoppingCartItem(GenericValue product, Map<String, GenericValue> additionalProductFeatureAndAppls, Map<String, Object> attributes, String prodCatalogId, Locale locale, String itemType, ShoppingCart.ShoppingCartItemGroup itemGroup) {
        this(product, additionalProductFeatureAndAppls, attributes, prodCatalogId, null, locale, itemType, itemGroup, null);
         if (product != null) {
            String productName = ProductContentWrapper.getProductContentAsText(product, "INTERNAL_NAME", this.locale, null);
            ...
            if (UtilValidate.isEmpty(productName)) {
                ...
                if (parentProduct != null) {
                    productName = ProductContentWrapper.getProductContentAsText(parentProduct, "INTERNAL_NAME", this.locale, null);
                }
            }
    ...
    /** Sets the Snf percentage*/
    public void setSnf(BigDecimal snf) {
        this.snf = snf;
    }

    /** Returns the Snf percentage */
    public BigDecimal getSnf() {
        return this.snf;
    }
    /** Sets the Fat percentage */
    public void setFat(BigDecimal fat) {
        this.fat = fat;
    }

    /** Returns the Fat percentage */
    ...
    /** Sets the supplyTypeEnumId */
    public void setSupplyTypeEnumId(String supplyTypeEnumId) {
        this.supplyTypeEnumId = supplyTypeEnumId;
    }

    /** Returns the supplyTypeEnumId */
    public String getSupplyTypeEnumId() {
        return this.supplyTypeEnumId;
    }
    
    /** Sets the unitPremiumPrice */
    public void setUnitPremiumPrice(BigDecimal unitPremiumPrice) {
        this.unitPremiumPrice = unitPremiumPrice;
    }

    /** Returns the unitPremiumPrice */
    public BigDecimal getUnitPremiumPrice() {
        return this.unitPremiumPrice;
    }
    
    /** Sets the sQuantityLtrs */
    public void setSQuantityLtrs(BigDecimal sQuantityLtrs) {
        this.sQuantityLtrs = sQuantityLtrs;
    }

    /** Returns the sQuantityLtrs */
    public BigDecimal getSQuantityLtrs() {
        return this.sQuantityLtrs;
    }
    
    /** Sets the SFat */
    public void setSFat(BigDecimal sFat) {
        this.sFat = sFat;
    }

    /** Returns the SFat */
    public BigDecimal getSFat() {
        return this.sFat;
    }
    /** Sets the sUnitPrice */
    ...
    /** Returns the sUnitPrice */
    public BigDecimal getSUnitPrice() {
        return this.sUnitPrice;
    }
    /** Sets the cQuantityLtrs */
    public void setCQuantityLtrs(BigDecimal cQuantityLtrs) {
        this.cQuantityLtrs = cQuantityLtrs;
    }

    /** Returns the cQuantityLtrs */
    public BigDecimal getCQuantityLtrs() {
        return this.cQuantityLtrs;
    }
    /** Sets the quantityKgs */
    public void setQuantityKgs(BigDecimal quantityKgs) {
        this.quantityKgs = quantityKgs;
    }
    /** Returns the quantityKgs */
    public BigDecimal getQuantityKgs() {
        return  this.quantityKgs;
    }
    /** Sets the LactoReading Value */
    public void setLactoReading(BigDecimal lactoReading) {
        this.lactoReading = lactoReading;
    }
    /** Returns the LactoReading Value */
    public BigDecimal getLactoReading() {
        return  this.lactoReading;
    }
    
    /** Sets the quantityLtrs */
    public void setQuantityLtrs(BigDecimal quantityLtrs) {
    	this.quantityLtrs = quantityLtrs;
    }
    /** Returns the quantityLtrs */
    public BigDecimal getQuantityLtrs() {
        return  this.quantityLtrs;
    }  
   ...
   /* set tax amount here */
    ...
    /** Returns the bed amount. */
    public BigDecimal getBedAmount() {
        return bedAmount;
    }
    
    /** Returns the Bedcess percent. */
    public BigDecimal getBedcessPercent() {
        return bedcessPercent;
    }
    
    /** Returns the Bedcess amount. */
    public BigDecimal getBedcessAmount() {
        return bedcessAmount;
    }
    
    /** Returns the bedseccess percent. */
    public BigDecimal getBedseccessPercent() {
        return bedseccessPercent;
    }
    
    /** Returns the bedseccess amount. */
    public BigDecimal getBedseccessAmount() {
        return bedseccessAmount;
    }
    
    /** set the the vat percent.*/
    public void setTaxDetails(List taxList) {

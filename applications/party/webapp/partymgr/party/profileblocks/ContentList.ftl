...
-->
              <td>${pContent.contentName?if_exists}</td>
              <td>${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, pContent.partyId, false)}</td>
<#--              
...
-->
              ...
              <td class="button-col">
                <#if (pContent.contentName?has_content)>
                    <a href="<@ofbizUrl>img/${pContent.contentName}?imgId=${pContent.dataResourceId}</@ofbizUrl>">${uiLabelMap.CommonView}</a>
                </#if>
<#--                

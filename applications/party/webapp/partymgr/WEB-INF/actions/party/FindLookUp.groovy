...
if(UtilValidate.isNotEmpty(parameters.partyClassificationGroupId)){	
	context.entityName="PartyNameViewClasification";
}	
if(UtilValidate.isNotEmpty(parameters.roleTypeId)){	
	context.entityName="PartyRoleAndPartyDetail";
}	
if(UtilValidate.isNotEmpty(parameters.roleTypeId) && UtilValidate.isNotEmpty(parameters.partyClassificationGroupId)){
	parameters.roleTypeId=parameters.roleTypeId;
	context.entityName="PartyRoleAndPartyDetailClasification";
}
...
if (executeResult.listIt == null) {
 ...
 Debug.log("Entity name" + context.entityName+ "]" +parameters.roleTypeId);

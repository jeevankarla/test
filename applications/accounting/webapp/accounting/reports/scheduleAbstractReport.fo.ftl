					  ...
					  <fo:table-column column-width="120pt"/>
					      <fo:table-body>
						      <fo:table-row >
								 ...
								 <fo:table-cell border="solid">
									 <fo:block text-align="left" keep-together="always" font-weight="bold">CURRENT YEAR</fo:block>
									 <fo:block text-align="left" keep-together="always">APR_MAR16</fo:block>
									 
								 </fo:table-cell>
	                             <fo:table-cell border="solid">
									 <fo:block text-align="left" keep-together="always" font-weight="bold">PREVIOUS YEAR</fo:block>
									 <fo:block text-align="left" keep-together="always">${prevsYear}</fo:block>
							  ...
							  <#if parameters.glAccountCategoryTypeId?has_content>
								<#if parameters.glAccountCategoryTypeId != "BS">
								 ...
								 <#list parentList as eachParent>
									 ...
									 <fo:table-row >
								  		<fo:table-cell border="solid">
											 <fo:block text-align="center"  > <#if parentDetails?has_content>${parentDetails.parentCatName?if_exists}</#if>[${eachParent}]</fo:block>
										...
										<fo:table-cell border="solid">
											 <fo:block text-align="center"  > ${eachParent}</fo:block>
											 <fo:block text-align="center" keep-together="always"></fo:block>
										</fo:table-cell>
										<fo:table-cell border="solid">
											 <fo:block text-align="right" > <#if presentParentDetails?has_content>${presentParentDetails.parentCurrentYearBal?string("##0.00")}<#else>0.00</#if></fo:block>
										</fo:table-cell>
										<fo:table-cell border="solid">
											  	 <fo:block text-align="right"    keep-together="always"><#if previousParentDetails?has_content>${previousParentDetails.parentCurrentYearBal?string("##0.00")}<#else>0.00</#if></fo:block>
										</fo:table-cell>
									 </fo:table-row>
								</#list>
								<#else>

										   ...
										   <fo:table>
											  ...
											  <#assign profitCategoryList = profitChildWiseMap.entrySet()>
											      <fo:table-body>
												 	...
												 	<fo:table-row >
											             <fo:table-cell border="solid" >
															 <fo:block text-align="left" keep-together="always" font-weight="bold">${profitValues.get("scheduleNo")} - ${profitValues.get("childCatName")}</fo:block>
														 </fo:table-cell>
														 <fo:table-cell border="solid">
												 	...
												 	<fo:table-row >
											             <fo:table-cell border="solid" >
															 <fo:block text-align="left" keep-together="always" >${glAccountIdWise.get("glAccountId")} - ${glAccountIdWise.get("description")} </fo:block>
														 </fo:table-cell>
														 <fo:table-cell border="solid">
											  ...
											  <fo:table-column column-width="135pt"/>
											      <fo:table-body>
											            <#assign lossCategoryList= lossChildWiseMap.entrySet()>
													 	...
													 	<fo:table-row>
												             <fo:table-cell border="solid" >
																 <fo:block text-align="left" keep-together="always" font-weight="bold">${values.get("scheduleNo")} - ${values.get("childCatName")}</fo:block>
															 </fo:table-cell>
															 <fo:table-cell border="solid">
																 <fo:block text-align="right" keep-together="always" font-weight="bold">${presentYearVal?if_exists?string("#0.00")}</fo:block>
															 </fo:table-cell>
											      ...
											      <fo:table-body>
												      <fo:table-row >
											             <fo:table-cell border="solid" border-right-style="hidden">
															 <fo:block text-align="left" keep-together="always" font-weight="bold">TO VALUE TRANSFERRED TRADING A/C.</fo:block>
														 </fo:table-cell>
														 <fo:table-cell border="solid">
										   ...
										   <fo:table>
											  ...
											  <fo:table-column column-width="135pt"/>
											      <fo:table-body>
												      <fo:table-row >
											             <fo:table-cell border="solid" border-right-style="hidden">
															 <fo:block text-align="left" keep-together="always" font-weight="bold">BY VALUE TRANSFERRED TRADING A/C.</fo:block>
														 </fo:table-cell>
														 <fo:table-cell border="solid">

...
<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <#if allAcctgCodeTransEntryMap?has_content>	
        <#assign allAcctgCodeTransEntryList = allAcctgCodeTransEntryMap.entrySet()>
       
        <#list allAcctgCodeTransEntryList as allacctgTransEntryEach>
         <#assign acctgTransEntryList = allacctgTransEntryEach.getValue()>
         <#assign accountCodeId = allacctgTransEntryEach.getKey()>
                        ...
                        <fo:table>
                            ...
                            <fo:table-body>
                               <fo:table-row>
                                ...
                                <fo:table-cell >
                                    <fo:block text-align="left" font-size="11pt">Payment Method Type</fo:block>
                                </fo:table-cell>
                              </fo:table-row>
                              <fo:table-row>
                                <fo:table-cell >
                              ...
                              <fo:table-row>
                                ...
                                <fo:table-row>
                                        ...
                                        <fo:table-cell >
                                            <fo:block text-align="left" font-size="11pt"><#if paymentMethodType?exists>${paymentMethodType.description}</#if></fo:block>        
                                        </fo:table-cell>
                                    </fo:table-row>
                                </#list>
                                <fo:table-row>

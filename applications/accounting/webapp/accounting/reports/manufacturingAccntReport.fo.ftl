										   ...
										   <fo:table>
											  ...
											  <#assign profitCategoryList = profitChildWiseMap.entrySet()>
											      <fo:table-body>
												 	...
												 	<fo:table-row >
											             <fo:table-cell border="solid" >
															 <fo:block text-align="left" keep-together="always" font-weight="bold">${profitValues.get("childCatName")}</fo:block>
														 </fo:table-cell>
														 <fo:table-cell border="solid" >
											  ...
											  <fo:table-column column-width="135pt"/>
											      <fo:table-body>
											            <#assign lossCategoryList= lossChildWiseMap.entrySet()>
													 	...
													 	<fo:table-row>
												             <fo:table-cell border="solid" >
																 <fo:block text-align="left" keep-together="always" font-weight="bold">${values.get("childCatName")}</fo:block>
															 </fo:table-cell>
															 <fo:table-cell border="solid" >

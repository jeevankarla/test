        			...
        			<fo:table-column column-width="25%"/>
	                    <fo:table-body>
	                    		<#assign paymentGroupDetails = {}>
        						 	<#if finAccntTransGroupId?has_content>
								    	<#assign paymentGroupDetails = delegator.findOne("FinAccountTransGroup", {"finAccntTransGroupId" : finAccntTransGroupId}, true)?if_exists/>
								   </#if>
								   <#assign paymentGroupTypeDetails = {}>
								   <#if paymentGroupDetails.finAcntTrnsGrpTypeId?has_content>
								    	<#assign paymentGroupTypeDetails = delegator.findOne("FinAccountTransGroupType", {"finAcntTrnsGrpTypeId" : paymentGroupDetails.finAcntTrnsGrpTypeId}, true)?if_exists/>
								   </#if>
								   <fo:table-row> 
        						 	<fo:table-cell>
        						 	...
        						 	<fo:table-cell>
        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold">PAYMENT GROUP ID : ${finAccntTransGroupId?if_exists}</fo:block>
        						 	</fo:table-cell>
		        				</fo:table-row>
		        				<fo:table-row> 
        						 	<fo:table-cell>
									...
									<fo:table-cell>
        						 	...
        						 	<#-- <fo:table-cell>
        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"><#if paymentGroupDetails.finAcntTrnsGrpTypeId?has_content && (paymentGroupDetails.paymentMethodTypeId == "CHEQUE_PAYIN" || paymentGroupDetails.paymentMethodTypeId == "CHEQUE_PAYOUT")>CHEQUE</#if><#if paymentGroupDetails.paymentMethodTypeId?has_content && (paymentGroupDetails.paymentMethodTypeId == "CASH_PAYIN" || paymentGroupDetails.paymentMethodTypeId == "CASH_PAYOUT")>CASH</#if></fo:block>
        						 	</fo:table-cell>-->
        						 	<fo:table-cell>
        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold">PAYMENT DATE:${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(paymentGroupDetails.finAccntTransDate?if_exists, "dd-MM-yyyy")}</fo:block>
        						 	</fo:table-cell>
		        				</fo:table-row>
        						 <#-- <#if paymentGroupDetails.paymentMethodTypeId?has_content && (paymentGroupDetails.paymentMethodTypeId == "CHEQUE_PAYIN" || paymentGroupDetails.paymentMethodTypeId == "CHEQUE_PAYOUT")> 
	        						 ...
	        						 <fo:table-row> 
	        						 	<fo:table-cell>
	        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold">&#160;CHEQUE NO:${paymentGroupDetails.contraRefNum?if_exists}</fo:block>
	        						 	</fo:table-cell>
	        						 	<fo:table-cell>
	        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"></fo:block>
	        						 	</fo:table-cell>
	        						 ...
	        						 <fo:table-row> 
	        						 	<fo:table-cell>
	        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"><#if paymentGroupDetails?has_content>&#160;CHEQUE BANK DETAILS:${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, paymentGroupDetails.issuingAuthority, false)?if_exists}</#if></fo:block>
	        						 	</fo:table-cell>
	        						 	<fo:table-cell>
	        						 		<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"></fo:block>
	        						 	</fo:table-cell>
        						...
        						<#assign totalAmount = 0>
        						  ...
        						  <#assign  partyName="">
        						  <#assign  partyId="">
        						  <#if paymentListReport.partyId?exists>
			            			  <#assign partyId = paymentListReport.partyId> 
			            			  <#assign partyName = Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, partyId, false)>
			            		  </#if>
        						 	<fo:table-row>
		        						<fo:table-cell>
		        								<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"> &#160; </fo:block>
		        								<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold">PAYMENT ID :${paymentListReport.finAccountTransId?if_exists}</fo:block>
		        						</fo:table-cell>
	        						 	<fo:table-cell>
												<fo:block text-align="left" font-size="12pt" white-space-collapse="false" keep-together="always" font-weight="bold"> &#160; </fo:block>

    ...
    <#if glAcctgTrialBalanceList?has_content>
        <div>
            <form name="glAccountTrialBalanceReport" id="glAccountTrialBalanceReport">
                <div>
                    <a href="<@ofbizUrl>FinancialAccountTransForMonth.csv?organizationPartyId=${organizationPartyId}&amp;fromDate=${parameters.fromDate}&amp;thruDate=${parameters.thruDate}&amp;comments=${parameters.comments}&amp;isPosted=${parameters.isPosted}&amp;finAccountId=${parameters.finAccountId}</@ofbizUrl>" target="_blank" class="buttontext">${uiLabelMap.AccountingExportAsCsv}</a>
		               		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   		                   
               		<a href="<@ofbizUrl>FinancialAccountTransForMonth.pdf?organizationPartyId=${organizationPartyId}&amp;fromDate=${parameters.fromDate}&amp;thruDate=${parameters.thruDate}&amp;comments=${parameters.comments}&amp;isPosted=${parameters.isPosted}&amp;finAccountId=${parameters.finAccountId}</@ofbizUrl>" target="_blank" class="buttontext">${uiLabelMap.AccountingExportAsPdf}</a>
                </div>
                <#--<div>

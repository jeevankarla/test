...
<script type="application/javascript">
		...
		var dataView;
		var grid;
		var data = ${StringUtil.wrapString(assetAccountBalanceData)};
...
<script type="application/javascript">
		var dataViewExp;
		var gridExp;
		var dataExp = ${StringUtil.wrapString(liabilityAccountBalanceData)};
...
<script type="application/javascript">
		var dataViewInc;
		var gridInc;
		var dataInc = ${StringUtil.wrapString(equityAccountBalanceData)};
...
<script type="application/javascript">
		var dataViewBato;
		var gridBato;
		var dataBato = ${StringUtil.wrapString(balanceTotalData)};

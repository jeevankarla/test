      ...
      <table class="basic-table" cellspacing="0">
        ...
        <#list customTimePeriods as customTimePeriod>
          ...
          <tr>
            <form method="post" action='<@ofbizUrl>updateCustomTimePeriod</@ofbizUrl>' name='lineForm${line}'>
             <td>${customTimePeriod.customTimePeriodId}</td>
            <td> <#if (currentCustomTimePeriod.parentPeriodId)?exists>${currentCustomTimePeriod.parentPeriodId}</#if></td>
            <td><#if (customTimePeriod.organizationPartyId)?exists>${customTimePeriod.organizationPartyId}</#if></td>
            <td><#if (customTimePeriod.periodTypeId)?exists>${customTimePeriod.periodTypeId}</#if></td>
            <td><#if (customTimePeriod.periodNum)?exists>${customTimePeriod.periodNum}</#if></td>
            <td><#if (customTimePeriod.periodName)?exists>${customTimePeriod.periodName}</#if></td>
            <td>
              <#assign hasntStarted = false>
              <#assign compareDate = customTimePeriod.getDate("fromDate")>
              <#if compareDate?has_content>
              ...
              <span <#if hasntStarted> class="alert"</#if>>${customTimePeriod.fromDate}</span>
            </td>
            <td>
              <#assign hasExpired = false>
              <#assign compareDate = customTimePeriod.getDate("thruDate")>
              ...
              <span <#if hasntStarted> class="alert"</#if>>${customTimePeriod.thruDate}</span>
             </td>
          </form>
          </tr>
        </#list>

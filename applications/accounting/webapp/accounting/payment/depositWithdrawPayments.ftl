                ...
                <table class="basic-table">
                    ...
                    <#list paymentList as payment>                    	
                        ...
                        <tr <#if alt_row> class="alternate-row"</#if>>
                            ...
                            <td align="right">
                            	<#if isReceipt >${uiLabelMap.AccountingDeposit} 
                            		<#else>${uiLabelMap.AccountingWithdraw}
                            	</#if>
                            	<input type="checkbox" id="paymentId_${payment_index}" name="paymentIds" value="${payment.paymentId}" onclick="javascript:getPaymentRunningTotal();"/></td>
                        </tr>
                        <#assign alt_row = !alt_row>
                    </#list>
                    <#if hasFinDwEditPermission >
                    <div align="right">

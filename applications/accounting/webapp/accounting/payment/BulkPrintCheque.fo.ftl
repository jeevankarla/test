...
<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:page-sequence master-reference="main">
        	...
        	<#assign finAccountId=payment.finAccountId>
        	<fo:flow flow-name="xsl-region-body">
        	<#if payment.paymentDate?has_content>
        	<fo:block  keep-together="always" text-align="right" font-size = "13pt" font-family="Courier,monospace" white-space-collapse="false" font-weight= "bold">${Static["org.ofbiz.base.util.UtilDateTime"].toDateStringBankFormat(payment.paymentDate?if_exists, "ddMMyyyy")}</fo:block>
        	</#if>
              ...
              <fo:block linefeed-treatment="preserve">&#xA;</fo:block>
                <fo:table>
                    ...
                    <fo:table-body> 
							...
							<fo:table-row>
				       			<fo:table-cell>
				            		<fo:block text-align="left" keep-together="always" font-size = "12pt">&#160;&#160;&#160;&#160;&#160;${payment.attrValue?if_exists}</fo:block>     
				       			</fo:table-cell>
							</fo:table-row>
							<fo:table-row>
								<fo:table-cell>
							...
							<#else>
			                 <#assign amountWords = Static["org.ofbiz.base.util.UtilNumber"].formatRuleBasedAmount(payment.amount, "%rupees-and-paise", locale).toUpperCase()>
							</#if>
			                  <fo:table-cell>
							...
							<fo:table-row>
								...
								<fo:table-cell>
				            		<fo:block text-align="right" keep-together="always" font-size = "12pt">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;${payment.amountStr?if_exists}</fo:block>          
				       			</fo:table-cell>
				       		</fo:table-row>
	               	</fo:table-body>
                </fo:table>
    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
       ...
       <#if payments?has_content > 
        <fo:page-sequence master-reference="main">
        	...
        	<#list payments as payment>
            <#assign finAccountId= payment.finAccountId>
            <#if finAccountId?has_content && (finAccountId=="FIN_ACCNT22" || finAccountId=="FIN_ACCNT31" || finAccountId=="FIN_ACCNT35" ||finAccountId=="FIN_ACCNT39" || finAccountId=="FIN_ACCNT40" || finAccountId=="FIN_ACCNT53")>
        	<fo:flow flow-name="xsl-region-body">
        	<#if payment.paymentDate?has_content>
        	<fo:block  keep-together="always" text-align="right" font-size = "13pt" font-family="Courier,monospace" white-space-collapse="false" font-weight= "bold">${Static["org.ofbiz.base.util.UtilDateTime"].toDateStringBankFormat(payment.paymentDate?if_exists, "ddMMyyyy")}</fo:block>
        	</#if>
              ...
              <fo:block linefeed-treatment="preserve">&#xA;</fo:block>
                <fo:table>
                    ...
                    <fo:table-body> 
							...
							<fo:table-row>
							<#if payment.amountinWords?has_content>
							 <#assign amountWords =payment.amountinWords>
							<#else>
			                 <#assign amountWords = Static["org.ofbiz.base.util.UtilNumber"].formatRuleBasedAmount(payment.amount, "%rupees-and-paise", locale).toUpperCase()>
							</#if>
			                  <fo:table-cell>
...
<#--  Bank of Baroda --> 
         <#if finAccountId?exists && (finAccountId == "FIN_ACCNT11" || finAccountId == "FIN_ACCNT12")>
        	<fo:flow flow-name="xsl-region-body">
        	<fo:block  keep-together="always" text-align="right" font-size = "12pt" font-family="Courier,monospace" white-space-collapse="false" font-weight= "bold">${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(payment.paymentDate?if_exists, "dd MM yyyy")}</fo:block>
        	<fo:block linefeed-treatment="preserve">&#xA;</fo:block>
              <fo:block font-size="12pt">                
                <fo:table>
                    <fo:table-column column-width="100pt"/>

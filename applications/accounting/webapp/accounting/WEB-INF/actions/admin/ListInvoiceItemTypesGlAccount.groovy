...
invoiceItemTypes = delegator.findList("InvoiceItemTypeMapInvoiceType",EntityCondition.makeCondition("parentTypeId", EntityOperator.EQUALS, invoiceTypeId) , null, null, null, false);
Debug.logInfo("this is invoiceItemTypes"+invoiceItemTypes,"");
allTypes = [];
invoiceItemTypes.each { invoiceItemType ->
    ...
    glAccount = null;
    List conditionList=[];
	conditionList.add(EntityCondition.makeCondition("invoiceItemTypeId", EntityOperator.EQUALS, invoiceItemType.get("invoiceItemTypeId")));
    ...
    invoiceItemTypeOrgs = delegator.findList("InvoiceItemTypeGlAccount", condition , null, null, null, false );
    overrideGlAccountId = " ";
    if (invoiceItemTypeOrgs) {
        ...
        glAccount = delegator.findList("GlAccount",EntityCondition.makeCondition("glAccountId", EntityOperator.EQUALS, invoiceItemType.get("defaultGlAccountId"))  , null, null, null, false );
    }
    ...
    allTypes.add([invoiceItemTypeId : invoiceItemType.invoiceItemTypeId,
                  description : invoiceItemType.invoiceItemTyeDescription,

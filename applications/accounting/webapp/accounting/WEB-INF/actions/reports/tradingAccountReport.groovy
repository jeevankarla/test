...
//Map GrandTotal = context.getAt("GrandTotal");
Map GrandManufactureProfitTotal = context.getAt("GrandProfitTotal");
Map GrandManufactureLossTotal = context.getAt("GrandLossTotal");
customTimePeriodIds = [];
parentCategoryIds = [];
...
/*if(GrandTotal && GrandTotal.get(eachCustmTime)){
	profitGrandTotal = profitGrandTotal+GrandTotal.get(eachCustmTime);
}*/
if(GrandManufactureProfitTotal && GrandManufactureProfitTotal.get(eachCustmTime)){
	profitGrandTotal = profitGrandTotal+GrandManufactureProfitTotal.get(eachCustmTime);
}
if(GrandManufactureLossTotal && GrandManufactureLossTotal.get(eachCustmTime)){
	lossGrandTotal = lossGrandTotal+GrandManufactureLossTotal.get(eachCustmTime);
}
...
context.GrandManufactureProfitTotal=GrandManufactureProfitTotal;
context.GrandManufactureLossTotal=GrandManufactureLossTotal;

...
exprList1 = [EntityCondition.makeCondition("statusId", EntityOperator.EQUALS, "INVOICE_READY")];
...
fields = new HashSet(["invoiceId", "invoiceTypeId", "currencyUomId", "description", "invoiceDate","shipmentId"]);

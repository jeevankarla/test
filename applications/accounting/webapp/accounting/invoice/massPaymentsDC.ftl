  ...
  function forBankNames(){
	...
	function massInvoicePayments(form) {
	  ...
	  function showPaymentEntryForInvoListing(invoiceId,grandTotal,balance,partyIdFrom,partyIdTo,partyName,purposeTypeId1) {
		...
		message += "<html><head></head><body><form action='createBranchInvoiceApplyPayment' id='chequePayForm' method='post' onsubmit='return disableGenerateButton();'><table cellspacing=20 cellpadding=20 width=550>";
			//message += "<br/><br/>";
	  ...
	  function showPaymentEntryBranchPurchaseForInvoListing(invoiceId,grandTotal,balance,partyIdFrom,partyIdTo,partyName,purposeTypeId1) {
		var message = "";
		invoiceId = invoiceId;
		...
		message += "<html><head></head><body><form action='createBranchPurchaseInvoiceApplyPayment' id='chequePayForm' method='post' onsubmit='return disableGenerateButton();'><table cellspacing=20 cellpadding=20 width=550>";
			//message += "<br/><br/>";

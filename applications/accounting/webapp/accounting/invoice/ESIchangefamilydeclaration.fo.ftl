...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<fo:table-column column-width="7in"/>
		<fo:table-body>
				<fo:table-row>
					<fo:table-cell>		
						<fo:block font-weight="bold" keep-together="always" font-size="14pt" text-align="center">FORM 1B</fo:block>
						<fo:block font-weight="bold" keep-together="always" font-size="14pt" text-align="center">CHANGES IN FAMILY DECLARATION FORM</fo:block>
						<fo:block font-weight="bold" keep-together="always" font-size="12pt" text-align="center">[Regulation 15B]</fo:block><fo:block linefeed-treatment="preserve"> &#xA;</fo:block>
					</fo:table-cell>
				</fo:table-row>
				<fo:table-row>
				...
				<fo:table-row>
 					<fo:table-cell><fo:block white-space-collapse="false" keep-together="always" text-align="left" >.              I hereby declare that the person / persons whose particulars are given below has / have now </fo:block></fo:table-cell>
				</fo:table-row>
				<fo:table-row>
 					<fo:table-cell><fo:block white-space-collapse="false" keep-together="always" text-align="left" >become / ceased to be members of my family :</fo:block><fo:block linefeed-treatment="preserve"> &#xA;</fo:block></fo:table-cell>
				</fo:table-row>		
		</fo:table-body>
	</fo:table>
   		...
   		<fo:table-column column-width="1.2in"/>	
   			<fo:table-body border="solid">
   				<fo:table-row border-left="solid" border-width="1pt" white-space-collapse="false">
    				...
    				<fo:table-cell><fo:block border-right="solid" border-top="solid" text-align="center" >Reasons for </fo:block><fo:block border-right="solid" text-align="center" >change</fo:block></fo:table-cell>
				</fo:table-row>
				<fo:table-row border-left="solid" border-width="1pt" white-space-collapse="false">
		...
		<fo:table-column column-width="4in"/>
			<fo:table-body>
				<fo:table-row>
    				...
    				<fo:table-cell><fo:block keep-together="always" text-align="right">I hereby declare that the particulars given above are true to the best of my knowledge and belief.</fo:block></fo:table-cell>
				</fo:table-row>
				<fo:table-row>
    				...
    				<fo:table-cell><fo:block linefeed-treatment="preserve"> &#xA;</fo:block><fo:block text-align="right">Signature /Thumb-impression of the insured person</fo:block><fo:block text-align="center">Countersigned ………………………</fo:block><fo:block text-align="center">Date …………………………………</fo:block><fo:block text-align="center">Designation…………………………</fo:block><fo:block linefeed-treatment="preserve"> &#xA;</fo:block>
    				</fo:table-cell>
				</fo:table-row>
				<fo:table-row>

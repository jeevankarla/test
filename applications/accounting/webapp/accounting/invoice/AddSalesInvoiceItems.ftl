...
<script type="text/javascript">
	...
	function setParameters() {
		...
		var hiddenVat = document.createElement("input");
	    hiddenVat.setAttribute("type", "hidden");
	    hiddenVat.setAttribute("name", "VAT_SALE");
	    hiddenVat.setAttribute("value", jQuery('input[name=vatPercent]').val());
	    formName.appendChild(hiddenVat);
	    var hiddenVatAmt = document.createElement("input");
	    hiddenVatAmt.setAttribute("type", "hidden");
	    hiddenVatAmt.setAttribute("name", "VAT_SALE_AMT");
	    ...
	    hiddenCst.setAttribute("name", "CST_SALE");
	    ...
	    hiddenCstAmt.setAttribute("name", "CST_SALE_AMT");
	    ...
	    hiddenServTax.setAttribute("name", "SERTAX_SALE");
	    ...
	    hiddenServTaxAmt.setAttribute("name", "SERTAX_SALE_AMT");
	    ...
	    hiddenExise.setAttribute("name", "BED_SALE");
	    ...
	    hiddenExiseAmt.setAttribute("name", "BED_SALE_AMT");
	...
	function showTaxForm() {	
		...
		message += "<form name='addTaxTypes' method='post'><table cellspacing=10 cellpadding=10>" ; 		
			message += 	"<tr class='h3'><td align='left' class='h3' width='40%'>Tax Type</td><td align='left' width='10%'>Percentage(%)    Amount</td></tr>";
	...
	function saveInvoiceItem() {
		...
		var vatPerVal=jQuery('input[name=VAT_SALE]').val();
		var vatAmtVal=jQuery('input[name=VAT_SALE_AMT]').val();
		var cstPerVal=jQuery('input[name=CST_SALE]').val();
		var cstAmtVal=jQuery('input[name=CST_SALE_AMT]').val();
		var servPerVal=jQuery('input[name=SERTAX_SALE]').val();
		var servAmtVal=jQuery('input[name=SERTAX_SALE_AMT]').val();
		var bedPerVal=jQuery('input[name=BED_SALE]').val();
		var bedAmtVal=jQuery('input[name=BED_SALE_AMT]').val();	
		 		...
		 		<form name="listInvoiceItems" id="listInvoiceItems"  method="post" action="">
				    <table id="customFields" class="basic-table hover-bar" cellspacing="0" width="10">
				      ...
				      <tbody>
				        ...
				        <#assign listVal=Static["org.ofbiz.base.util.UtilMisc"].toList("VAT_SALE", "CST_SALE","SERTAX_SALE","BED_SALE")>
				        <#list invoiceItems as invoice>
				            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
				              ...
				              <td>${invoiceItemType.description?if_exists}</td>

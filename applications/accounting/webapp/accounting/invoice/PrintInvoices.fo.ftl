										...
										<fo:table-row>
  											<fo:table-cell><fo:block></fo:block></fo:table-cell>
  												<#if invoice.invoiceTypeId =="PAYROL_INVOICE">
 	 												<fo:table-cell><fo:block font-weight="bold" font-size="16pt" border=".5pt solid" border-width=".05mm" text-align="center">${invoice.getRelatedOne("InvoiceType").get("description",locale)?if_exists}</fo:block></fo:table-cell>
 	 												<#else>
                        ...
                        <fo:table width="100%" table-layout="fixed">
                          ...
                          <fo:table-body>
                            ...
                            <fo:table-row>
                              ...
                              <fo:table-cell>
                                <fo:block>
                                  <#if partyName?has_content>${dispalyParty.partyId}</#if>
                                </fo:block>
                              </fo:table-cell>
                            </fo:table-row>
              ...
              <fo:block>
                <fo:table width="100%" table-layout="fixed" space-after="0.3in">
                  ...
                  <fo:table-body>
                    ...
                    <#if invoice.invoiceTypeId =="PAYROL_INVOICE">
     <fo:table-row >
        <fo:table-cell> <fo:block number-columns-spanned="2" font-weight="bold">Department : ${billingParty.getRelatedOne("PartyGroup").get("groupName",locale)}</fo:block>
        </fo:table-cell>
    </fo:table-row>
    </#if>
                  </fo:table-body>

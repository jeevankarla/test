...
<#else>
    <fo:page-sequence master-reference="main">
        <fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace">
           ...
           <fo:block text-align="left"  white-space-collapse="false"  font-size="10pt" >C.S.T No : ${allDetailsMap.get("cstNumber")?if_exists}</fo:block>
           <fo:block text-align="left"  white-space-collapse="false"  font-size="10pt" >C.I.N No : ${allDetailsMap.get("cinNumber")?if_exists} </fo:block>
	...
	<fo:table-column column-width="25%"/>
		...
		<fo:table-body>
			<fo:table-row white-space-collapse="false">
				...
				<fo:block text-align="left" font-weight="bold" font-size="10pt" >Tin No : ${tinNo?if_exists}</fo:block>
				</#if>
				</fo:table-cell>
				<fo:table-cell >
		...
		<fo:table-body>
			...
			<fo:table-row white-space-collapse="false">
				<fo:table-cell number-columns-spanned="2" >
         			 <fo:block text-align="center"    font-size="10pt" >&#160;&#160;&#160;&#160;</fo:block>
	   	          <#--  <#if scheme != "General"> --> 
	   	          	<#if branchId == "INT6" || branchId == "INT12">
        				<fo:block>Transaction Type: ${TransactionTypevalue?if_exists}</fo:block>
        			</#if>

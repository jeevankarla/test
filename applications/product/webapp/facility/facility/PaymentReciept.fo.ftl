    ...
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:page-sequence master-reference="main">
        	<fo:static-content flow-name="xsl-region-before">
        		<fo:block text-align="left" white-space-collapse="false" font-size="11pt" font-weight="bold" keep-together="always">ANDHRA PRADESH DAIRY DEV. CO-OP. FEDN.LTD</fo:block>
        		<fo:block text-align="center" white-space-collapse="false" font-size="11pt" font-weight="bold" keep-together="always">            MPF:HYDERABAD</fo:block>

...
<#assign changeRowTitle = "TruckSheet Correction">                
...
$(document).ready(function(){
	...
	$('#boothId').keypress(function (e) {
		if (e.which == $.ui.keyCode.ENTER) {
			$('#trucksheetcorrectioninit').submit();
			return false;   
		}
	});	
...
<div class="screenlet">
	<div class="screenlet-title-bar">
        <ul>
   			<li>
   				<a href="<@ofbizUrl>checkListReport?userLoginId=${userLogin.get("userLoginId")}&&checkListType=trucksheetcorrection</@ofbizUrl>" target="_blank">TruckSheet Correction Check List</a>
            </li>
         </ul>
     </div>
    <div class="screenlet-body">
<form method="post" name="trucksheetcorrectioninit" id="trucksheetcorrectioninit" action="<@ofbizUrl>TruckSheetCorrection</@ofbizUrl>">  
      <table width="60%" border="0" cellspacing="0" cellpadding="0">     
       ...
       <#if booth?exists && booth?has_content>  
          ...
          <td valign='middle'>
            <div class='tabletext h2'>
               	${booth.facilityId} [${booth.parentFacilityId}: ${booth.facilityName}]             
            </div>
          </td>       
       <#else>               
          <td valign='middle'>          
...
<br/>
<form method="post" id="trucksheetcorrection" action="<@ofbizUrl>TruckSheetCorrectionInit</@ofbizUrl>">  
	...
	<input type="hidden" name="productSubscriptionTypeId" id="productSubscriptionTypeId" value="${parameters.productSubscriptionTypeId?if_exists}"/>   	   	   	   
 			...
 			<div class="grid-header" style="width:100%">
				<label>TruckSheet Correction</label>
			</div>
			<div id="myGrid1" style="width:100%;height:100px;"></div>
			<br>
<#if dataJSON?exists>					
    <div align="center">
    	<input type="submit" style="padding:.3em" id="changeSave" value="Save" onclick="javascript:processChangeIndent('trucksheetcorrection','<@ofbizUrl>processTruckSheetCorrection</@ofbizUrl>');"/>
    	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<div class="screenlet">
    <div class="screenlet-body">
 		<div class="grid-header" style="width:100%">
			<label>Last  Correction <#if lastChangeSubProdMap?exists && lastChangeSubProdMap?has_content>[made by ${lastChangeSubProdMap.modifiedBy?if_exists} at ${lastChangeSubProdMap.modificationTime?if_exists}] </#if></label>
		</div>    

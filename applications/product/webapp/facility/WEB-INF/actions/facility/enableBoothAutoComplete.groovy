...
boothsList = EntityUtil.filterByCondition(routesFacilitiesList, EntityCondition.makeCondition("facilityTypeId", EntityOperator.EQUALS, "BOOTH"));
if(tempRoute){
	...
	routesList.each{route ->
		boothsList = NetworkServices.getRouteBooths(delegator , UtilMisc.toMap("routeId",route.facilityId)).get("boothsList");
...
/*Debug.log("routesJson #######################################"+routesJSON);*/



//Debug.log("==============facilityItemsJSON==============="+facilityItemsJSON);

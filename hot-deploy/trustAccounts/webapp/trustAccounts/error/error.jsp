    ...
    <tr>
      <td>
        <table width="100%" border="0" height="200">
          ...
          <tr>
            <td>
              <div align="left"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><%=UtilFormatOut.replaceString(errorMsg, "org.ofbiz.webapp.control.RequestHandlerException", "Vbiz Exception")%></font></div>
            </td>
          </tr>
        </table>
      </td>
...
<div align="center"><img src="/vasista/powered_by_vasista.gif"></div>

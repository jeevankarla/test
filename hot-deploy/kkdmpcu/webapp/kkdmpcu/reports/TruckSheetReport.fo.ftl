                       ...
                       <fo:table width="100%" table-layout="fixed" space-after="0.0in">
			                ...
			                <fo:table-body>
            				 			...
            				 			<fo:table  table-layout="fixed" >                
			            					...
			            					<fo:table-body>                      						                      	
                  							...
                  							<fo:table-row >
	                 							...
	                 							<fo:table-cell >
	                     							<fo:block text-align="left">${totalSum}</fo:block>
	                 							</fo:table-cell>	
	                 							<fo:table-cell >
	                     							<fo:block text-align="left">${prevDue}</fo:block>
	                 							</fo:table-cell>
	                 							<fo:table-cell >
	                 							<#if (facilityTypeId != "ROUTE")>
        						...
        						<fo:table-row>                        
			    					<fo:table-cell >
			    					<#if (facilityTypeId != "ROUTE")>
			    						<fo:block white-space-collapse="false" white-space-treatment="preserve">                                                              TOT AMT:   ${facilityGrandTotal+prevDue}</fo:block>
			    						<fo:block>----------------------------------------------------------------------------------</fo:block>
	          							<fo:block linefeed-treatment="preserve">&#xA;</fo:block> 
			    						<fo:block>KRISHNAVENI KKDMPCU LTD VIJAYAWADA DELIVERY NOTE CUM INVOICE</fo:block>
			    					</#if>
			    					<#if (facilityTypeId == "ROUTE") >
			    						<fo:block>---------------------------------------------------------------------------------</fo:block>

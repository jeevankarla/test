            				 ...
            				 <fo:table  table-layout="fixed" >                
				                ...
				                <fo:table-body>
			              							...
			              							<fo:table-row >                    
						                            	<fo:table-cell>
						                      			...
						                      			<#list typeEntries as typeEntry> 
						                      				...
						                      				<#if typeEntry.getKey() != "NOPKTS" && typeEntry.getKey() != "NOCRATES" && typeEntry.getKey() != "TOTAL" && typeEntry.getKey() != "AGNTCS" && typeEntry.getKey() != "PTCCS" && typeEntry.getKey() != "CRATES" && typeEntry.getKey() != "CARD_AMOUNT"> 
							                      			   <fo:table-cell >
                       			...
                       			<fo:table-row >
	                 				...
	                 				<fo:table-cell>
	                     				<fo:block text-align="left">${totalLitres.toEngineeringString()}*</fo:block>
	                 				</fo:table-cell>
	                  				<fo:table-cell>

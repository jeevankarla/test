...
<script language="JavaScript" type="text/javascript">
 ...
 var facilityNameJSON = ${StringUtil.wrapString(facilityNameJSON)!'[]'};
 var products="";
...
function setfacilityId(facility){
 ...
 facilityName = facilityNameJSON[facilityId];
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
    	  <form name="FindFacilityProducts" id = "FindFacilityProducts" action="productionStockXfers"  method="post">
    	  <input type="hidden" name="hideSearch" id="hideSearch" value ="N"/>
    	   <table class="basic-table" cellspacing="0">
    	   	...
    	   	<#--	<td><@htmlTemplate.lookupField  formName="FindFacilityProducts" event="onblur" action="javascript:setfacilityId(this);" name="facilityId" id="facilityId" fieldFormName="LookupFacility"/></td> -->
                <td><input type="text" name="facilityId" id="facilityId" onblur='javascript:setfacilityId(this);'/><span  class="tooltip" id="facilityName"></span>
    	   	</tr>
    	   	<tr>

...
<#include "ProductionRequestEntryInc.ftl"/>
	...
	<div class="lefthalf">
		<div class="screenlet">
    		...
    		<div class="screenlet-body">
      			...
      			<form method="post" name="indententryinit" action="<@ofbizUrl><#if screenFlag?exists && screenFlag == "RETURN">ReturnEntry<#else>productionIndent</#if></@ofbizUrl>" id="indententryinit">  
			    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
        				...
        				<#if screenFlag?exists && screenFlag != "RETURN">
	        				<tr>
					      		...
					      		<#else>
					      			<input type="text" name="custRequestName" autocomplete="off" id="custRequestName" />
					      		</#if>
								</td>
							</tr>
							<tr><td><br/></td></tr>
						...
						<tr>
                        	...
                        	<#if partyIdFrom?exists && partyIdFrom?has_content> 
                             <input type="hidden" name="partyIdFrom" id="partyIdFrom" value="${partyIdFrom.toUpperCase()}"/>
                        	<td valign='middle'>
				        ...
				        <tr>
				          <td>&nbsp;</td>
				          <td align='left' valign='middle' nowrap="nowrap"><div class='h2'>${uiLabelMap.MaterialMangement_CustRequestToPartyId}</div></td>
				          <td>&nbsp;</td>
				...
				<form method="post" id="indententry" action="<@ofbizUrl>ProductionIndentEntryInit</@ofbizUrl>">  
					...
					<input type="hidden" name="custRequestTypeId" id="custRequestTypeId" value="INTERNAL_INDENT"/>
		...
		<div class="screenlet">
    		<div class="screenlet-body">
				...
				<div id="myGrid1" style="width:100%;height:350px;"></div>
			  	...
			  	<#if screenFlag?exists && screenFlag == "RETURN">
			  		<#assign formAction ='processProductionReturnItems'>
			  	<#else>
			  		<#assign formAction ='processProductionIndentItems'>
			  	</#if>
				...
				<#if booth?exists || party?exists>
			    	<div align="center">
			    		...
			    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			    		<input type="submit" style="padding:.3em" id="changeCancel" value="Cancel" onclick="javascript:processIndentEntry('indententry','<@ofbizUrl>productionIndent</@ofbizUrl>');"/>   	
			    	</div>     
				</#if>  
			</div>
		</div>     

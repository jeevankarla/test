...
<script type="application/javascript">
	...
	$("#indentAdjustmentTable tr :input:visible").each(function () {
		   ...
		   //=========================TenPercent=====================
		    ...
		    if(id == "CESS_PUR_AMT" || id == "INSURANCE_CHGS_PUR_AMT" || id == "OTHER_CHARGES_PUR_AMT" || id == "PACKING_FORWARDIG_PUR_AMT" || id == "ROUNDING_CHARGES_PUR_AMT" || id=="EXCISE_DUTY_PUR_AMT" || id=="FREIGHT_CHARGES_PUR_AMT") {

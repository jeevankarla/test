...
<#escape x as x?xml>
        ...
        <fo:page-sequence master-reference="main" font-size="10pt">	
        	...
        	<fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">	
               ...
               <fo:block>
        		...
        		<fo:block text-align="left" keep-together="always" white-space-collapse="false">towards the requirement of user agency M/s : <fo:inline font-weight="bold">${facilityName?if_exists}</fo:inline></fo:block>  
			            ...
			            <fo:table-body>
			                ...
			                <fo:table-row>
					           ...
					           <#--> <fo:table-cell border-style="solid">
					            ...
					            <fo:table-cell border-style="solid">
                                      <#assign purchaeTot =purchaeTot+orderList.get("totalPurCost")>
					                 <#assign toTunitPrice = toTunitPrice+orderList.get("totalCost")>
					            	<fo:block  keep-together="always" text-align="right" font-size="11pt" white-space-collapse="false">${orderList.get("totalPurCost")?if_exists?string("#0.00")}</fo:block>
					            </fo:table-cell>
					             <fo:table-cell border-style="solid">
							...
							<#assign sr=sr+1>
							 ...
							 <fo:table-row>
					            ...
					            <fo:table-cell border-style="solid">
					            	<fo:block  keep-together="always" text-align="right" font-size="11pt" white-space-collapse="false">${purchaeTot?string("#0.00")}</fo:block>
					            </fo:table-cell>
					            <fo:table-cell border-style="solid">
					            	<fo:block  keep-together="always" text-align="left" font-size="11pt" white-space-collapse="false"></fo:block>
					            </fo:table-cell>
	...
	<fo:block>Advance Details: Cheque/DD No : <#assign count = 0><#list paymentRefNumList as paymentRefNum><#assign count = count+1> ${paymentRefNum?if_exists} <#if count ==size><#else>,</#if> </#list> Cr on Account amounting (Rs) ${totAmt?string("#0.00")}  received from user agency M/S:<fo:inline font-weight="bold">${partyName?if_exists}</fo:inline></fo:block>
	<fo:block>&#160;&#160;&#160;&#160;&#160;</fo:block>
    <fo:block>&#160;&#160;&#160;&#160;&#160;</fo:block> 

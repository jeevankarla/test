...
<#escape x as x?xml>
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="main" page-height="12in" page-width="10in"  margin-left=".4in" margin-right=".4in" margin-top=".1in">
					           ...
					           <fo:table-cell border-style="solid">
								...
								<#list invocieList as invoice>
										<fo:table-row>
								            ...
								            <fo:table-cell  border-style="solid">
								            	<fo:block  text-align="right" font-size="9pt"  <#if invoice.get("partyName")=="TOTAL"> font-weight="bold"  </#if> white-space-collapse="false">${invoice.get("above3years")?if_exists}</fo:block>
								            </fo:table-cell >
										</fo:table-row> 
							     </#list>
						</fo:table-body>

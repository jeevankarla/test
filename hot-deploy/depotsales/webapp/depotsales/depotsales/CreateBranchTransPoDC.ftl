<#if orderType.equals("onbehalfof")>
	<#include "CreateBranchOnBehalfTransPOIncDC.ftl"/>
<#else>
	<#include "CreateBranchTransPoIncDC.ftl"/>
</#if>
    ...
    $(document).ready(function(){
            $("#wizard-2").steps({
                ...
                onFinished: function (event, currentIndex)
                {
				    ...
				    processPOEntryInternal("CreateMPO", "createPOByOrderDC");
                	form.submit();
                }
            });
	}); 
...
<form id="CreateMPO"  action="<@ofbizUrl>createPOByOrderDC</@ofbizUrl>" name="CreateMPO" method="post">
		       			...
		       			<td valign='middle'>
	          				<select name="purchaseTitleTransferEnumId" id="purchaseTitleTransferEnumId" class='h4' style="width:205px">
	          					<#if orderId?exists && orderInfo.get("purchaseTitleTransferEnumId")?exists>
	          						...
	          						<#if orderInfo.get("purchaseTitleTransferEnumId") == "EXEMPTED_GOODS">

...
function showAgencyAddress(orderId){
     ...
     var message = "";
                ...
                message += "<html><head></head><body><form id='agencyAddress'  name='agencyAddress'method='post' action='PurchaseOrderViewDepotSales.pdf' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10 width=400>";

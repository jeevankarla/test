...
// to show special related fields in form			
	...
	function updateTotalIndentAmount(){
		...
		var dispText = "";
		if(amt > 0 ){
			dispText = "<b>&nbsp;  Indent Value: Rs " +  amt + "&nbsp;</b>";
		}
		else{
			dispText = "<b>&nbsp;  Indent Value: Rs 0 &nbsp;</b>";
		}
		
		totalPayable = totalAmount - totalDiscount;
		
		jQuery("#totalAmount").html(dispText);
		jQuery("#itemsSelected").html("<b> &nbsp; Items Selected: "+data.length+" &nbsp; </b>");
		jQuery("#totalDiscount").html("<b> &nbsp; Total Subsidy: Rs "+totalDiscount+" &nbsp; </b>");
		jQuery("#totalPayable").html("<b> &nbsp; Total Payable: Rs "+totalPayable+" &nbsp; </b>");

	...
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:page-sequence master-reference="main" font-size="10pt">	
        	...
        	<fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">	
				...
				<fo:block text-align="center" font-size="10pt" font-weight="bold" >TRANSPORTATION AND DEPOT EXPENSES FOR THE PERIOD ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(daystart, "dd/MM/yyyy")?if_exists} To:${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(dayend, "dd/MM/yyyy")?if_exists} </fo:block>

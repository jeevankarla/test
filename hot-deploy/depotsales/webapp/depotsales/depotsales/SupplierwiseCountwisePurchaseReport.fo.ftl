	...
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:page-sequence master-reference="main" font-size="10pt">	
        	...
        	<fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">	
				...
				<fo:block text-align="center" font-size="12pt" font-weight="bold" >Supplier wise Count wise Purchase Report</fo:block>
	                    ...
	                    <fo:table-column column-width="12%"/>
			                 ...
			                 <fo:table-row>
								<fo:table-cell border-style="solid">
					            	<fo:block  text-align="center" font-size="10pt"  font-weight="bold" white-space-collapse="false">Product Category</fo:block>
					            </fo:table-cell >
					             <fo:table-cell border-style="solid">
					            	<fo:block  text-align="center" font-size="10pt"  font-weight="bold" white-space-collapse="false">Product Count</fo:block>
					            </fo:table-cell >
					            <fo:table-cell border-style="solid">

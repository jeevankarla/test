...
<script type="application/javascript">
	...
	function showInventorySaleQTip(productId, quantityOnHandTotal, unitCost) {
		...
		message +=  "<tr class='h3'><td align='left' class='h3' width='50%'>Quantity:</td><td align='left' width='50%'><input class='h3' type='text' id='quantity' name='quantity' value=''/></td><input type='hidden'  id='salesChannel' name='DEPOT_CHANNEL'/></tr>";

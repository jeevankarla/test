...
<script type="application/javascript">
	...
	function showItemAdjustmentsAndTaxes(gridRow, index) {
			...
			for(var i=0;i<allAdjustments.length;i++){
						...
						if(orderAdjAmt != 0){
						  ...
						  if(orderAdjustment.orderAdjustmentTypeId == "VAT" || orderAdjustment.orderAdjustmentTypeId == "CST" || orderAdjustment.orderAdjustmentTypeId == "VAT_SURCHARGE" || orderAdjustment.orderAdjustmentTypeId == "CST_SURCHARGE" || orderAdjustment.orderAdjustmentTypeId == "ENTRY_TAX"){
							message += "<tr>"+
	...
	$("#indentAdjustmentTable tr :input:visible").each(function () {
		   ...
		   //=========================TenPercent=====================
		    ...
		    if(id == "CESS_PUR_AMT" || id == "INSURANCE_CHGS_PUR_AMT" || id == "OTHER_CHARGES_PUR_AMT" || id == "PACKING_FORWARDIG_PUR_AMT" || id == "ROUNDING_CHARGES_PUR_AMT" || id == "FREIGHT_CHARGES_PUR_AMT") {

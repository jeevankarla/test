				...
				<div id="myGrid1" style="width:100%;height:210px;"></div>
					...
					<#if booth?exists || party?exists || partyId?exists >
				    	...
				    	<div align="center">
				    		...
				    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				    		<input type="submit" style="padding:.3em" id="changeCancel" value="Cancel" onclick="javascript:processIndentEntry('indententry','<@ofbizUrl>IndentorEditBranchIndent</@ofbizUrl>');"/>   	
				    	</div>     
					</#if>

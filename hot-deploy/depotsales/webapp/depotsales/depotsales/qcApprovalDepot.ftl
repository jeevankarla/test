...
<script type="application/javascript">
	...
	function QCApprovalBranchSalesQTip(shipmentId,partyIdTo) {
		...
		message +=  "<tr class='h3'><td align='left' class='h3' width='50%'>User Agency:</td><td align='left' width='50%'><input class='h3' type='text' readonly id='partyId' name='partyId' value='"+partyIdTo+"'/></td></tr>";

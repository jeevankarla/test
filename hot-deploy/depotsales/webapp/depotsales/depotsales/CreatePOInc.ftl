...
<script type="application/javascript">
	...
	function setupGrid1() {
        ...
        var columns = [
			...
			{id:"unitPrice", name:"Unit Price", field:"unitPrice", width:90, minWidth:90, cssClass:"readOnlyColumnClass", sortable:false, formatter: rateFormatter, align:"right", toolTip:"UD Price"},
			...
			<#--
			{id:"bedPercent", name:"Excise(%)", field:"bedPercent", width:80, minWidth:80, cssClass:"readOnlyColumnClass", sortable:false, formatter: rateFormatter, align:"right", toolTip:"Excise Percent", availableTags: exclableTags, cssClass:"readOnlyColumnClass",validator:excValidator},
			{id:"vatPercent", name:"VAT(%)", field:"vatPercent", width:80, minWidth:80, cssClass:"readOnlyColumnClass", sortable:false, formatter: rateFormatter, align:"right", toolTip:"VAT Percent", availableTags: vatlableTags, cssClass:"readOnlyColumnClass",validator:vatValidator},
			{id:"cstPercent", name:"CST (%)", field:"cstPercent", width:80, minWidth:80, cssClass:"readOnlyColumnClass", sortable:false, formatter: rateFormatter, align:"right", toolTip:"CST Percentage", availableTags: cstlableTags, cssClass:"readOnlyColumnClass",validator:cstValidator},-->

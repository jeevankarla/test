...
function showCancelOrderQtip(orderId){
		var orderId = orderId;
     	var message = "";
            message += "<html><head></head><body><form id='CancelOrderDC' method='post' action='CancelOrderDC' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10 width=400>";

...
function drawRow(rowData) {
 ...
 var partyName='\''+rowData.partyName+'\'';
    var PurchaseOrderView =partyName+'<a class="buttontext" href="<@ofbizUrl>viewprofile?partyId='+rowData.partyId+'</@ofbizUrl>" target="_blank">'+rowData.partyId+'</a>';
    ...
    var orderCustomMethod = "javascript:fetchOrderItemInformation("+ salesOrder + ","+purchaseOrder+")";
    var AmendOrder ='<input type=button name="Amend" id=Amend value="Amend Order" onclick="'+orderCustomMethod+'">';

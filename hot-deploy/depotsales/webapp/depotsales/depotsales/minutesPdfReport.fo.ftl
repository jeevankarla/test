			                ...
			                <fo:table-row>
					            ...
					            <fo:table-cell border-style="solid">
					             ...
					             <fo:table-cell border-style="solid">
					            	...
					            	<fo:block  keep-together="always" text-align="right" font-size="9pt" white-space-collapse="false"><#if orderList.get("Uom") == "/Bale">${orderList.get("baleQuantity")*40}(Bundles)<#elseif orderList.get("Uom") == "/Half-Bale">${orderList.get("baleQuantity")*20}(Bundles)<#elseif orderList.get("Uom") == "/Bundle">${orderList.get("quantity")}(Bundles)</#if></fo:block> 
						         </fo:table-cell>
					            <fo:table-cell border-style="solid">

	        ...
	        <fo:block >
			   ...
			   <fo:table-column column-width="100pt"/>               
				   <fo:table-body>
                       ...
                       <fo:table-row>
				           <fo:table-cell  ><fo:block text-align="left" font-size="11pt"  keep-together="always" font-weight="bold">PO Id:  <#if allDetailsMap.get("orderId")?has_content>${allDetailsMap.get("orderId")}</#if></fo:block></fo:table-cell>       			
                       </fo:table-row>
                       <fo:table-row>

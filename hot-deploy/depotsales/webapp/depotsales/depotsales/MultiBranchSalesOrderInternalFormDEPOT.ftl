...
<script type="application/javascript">
	...
	function setupGrid1() {
		...
		var columns1 = [
			...
			{id:"cProductName", name:"${uiLabelMap.Product}", field:"cProductName", width:280, minWidth:280, cssClass:"cell-title", availableTags: availableTags, regexMatcher:"contains" ,editor: AutoCompleteEditor, validator: productValidator, sortable:false ,toolTip:""},

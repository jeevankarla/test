...
<fo:page-sequence master-reference="main" force-page-count="no-force" font-family="Courier,monospace">					
	<fo:static-content flow-name="xsl-region-before">
        ...
        <fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">	
            ...
            <fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" font-weight="bold">PURCHASE ORDER <fo:inline font-weight="normal"><#if parameters.docType?has_content><#if parameters.docType=="Original">(Original Copy)<#else> (Duplicate Copy)</#if><#else> (Original Copy)</#if></fo:inline ></fo:block>
	        ...
	        <fo:block >
			   ...
			   <fo:table-column column-width="100pt"/>               
				   <fo:table-body>
                       ...
                       <fo:table-row>
				           <fo:table-cell  ><fo:block text-align="left" font-size="11pt"  ><#if allDetailsMap.get("refNo")?has_content>PO Ref NO   &#160;: ${allDetailsMap.get("refNo")?if_exists}</#if></fo:block></fo:table-cell>
   				           <fo:table-cell  ><fo:block text-align="left"  font-size="11pt"  >&#160;</fo:block></fo:table-cell>       		
	    ...
	    <fo:block text-align="left" font-family="Courier,monospace" white-space-collapse="false"  font-size="12pt" >${suppAdd.postalCode?if_exists}</fo:block> 
         ...
         <fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" >&#160;&#160;--------------------------------------------------------------------------------------------</fo:block>
      	 <fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" font-weight="bold">&#160;SNO    ITEM          REMARKS     QUANTITY    PACKING  PACKING   BASIC RATE     AMOUNT</fo:block>
      	 <fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" font-weight="bold">&#160;                                  (Kgs)        SIZE      NO         (Rs)          (Rs)             </fo:block>
      	<#-- <fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" >&#160;&#160;--------------------------------------------------------------------------------------------</fo:block>-->
    	 <fo:block>
       ...
       <#--><fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" >&#160;&#160;-------------------------------------------------------------------------------------------</fo:block>-->
        ...
        <#assign typeBase=typeBasedMap.entrySet()>
	      <#list typeBase as typeBaseList>
           ...
           <fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false" font-size="10pt" font-weight="bold">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;                                             ${typeBaseList.getKey()?if_exists} as ${eaValue.getKey()} % :${eaValue.getValue()?if_exists}  </fo:block>
            </#if>
            </#list>
        </#list>

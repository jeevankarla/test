...
function showPayrollGenerateForm() {	
		var message = "";
		message += "<form action='createDepotReimbursementBilling' method='post' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10>" ; 		
		...
		message += "</table></form>";				
		var title = "<h2><center>Generate Depot Reimbursement Bill</center></h2>";
		Alert(message, title);
	}

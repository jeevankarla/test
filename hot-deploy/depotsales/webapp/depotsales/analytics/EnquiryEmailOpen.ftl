...
<script type="application/javascript">
	...
	function showEnquiryEmail(supplierPartyId,custRequestId) {
      ...
      $.ajax({
		...
		message += "<div style='width:100%;height:350px;overflow-x:auto;overflow-y:auto;' ><form action='sendEmaiFromIndentAnalytics' method='post' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10  width='100%' > " ; 
			message +="<tr ><td align='right' class='h2' width='15%' >Send To: </td><td  class='h2' align='left' width='75%'>&nbsp;<input type='text' size='42'  id='sendTo' name='sendTo' value='nhdc.erp@gmail.com' readonly/>"+
					"</td></tr>";
					<#--
	...
	function populateDate(){
	     ...
	     jQuery("#sendFrom").val("vbiz@vasista.in");

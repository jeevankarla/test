		   ...
		   // prepare the data          
            ...
            $("#treeGrid").jqxTreeGrid(
            {
                ...
                columns: [
                 ...
                 // { text: 'Total Quanty', width:'15%', align: 'center', dataField: 'totalRevenue', cellsalign: 'right', cellsRenderer: cellsRenderer },
                  { text: 'Total Purchase Qty (Kgs in Lakhs)', width:'20%', align: 'center', dataField: 'totalIndents', cellsalign: 'right', cellsRenderer: cellsRenderer },
                  { text: 'Shipped Qty (Kgs in Lakhs)', width:'20%', align: 'center',  dataField: 'completed', cellsalign: 'right', cellsRenderer: cellsRenderer  },

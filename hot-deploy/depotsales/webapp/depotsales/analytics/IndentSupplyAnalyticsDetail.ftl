		   ...
		   // prepare the data          
            ...
            $("#treeGrid").jqxTreeGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Total Quanty (Kgs in Lakhs)', width:'12%', align: 'center', dataField: 'totalRevenue', cellsalign: 'right', cellsRenderer: cellsRenderer },
                  { text: 'Total SupplyBilled Qty (Kgs in Lakhs)', width:'12%', align: 'center', dataField: 'totalIndents', cellsalign: 'right', cellsRenderer: cellsRenderer },

		   ...
		   // prepare the data          
            ...
            $("#treeGrid").jqxTreeGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Total Purchase Order Qty', width:'15%', align: 'center', dataField: 'totalIndents', cellsalign: 'right', cellsRenderer: cellsRenderer },
                  { text: 'Pending Qty', width:'15%', align: 'center', dataField: 'inProcess', cellsalign: 'right', cellsRenderer: cellsRenderer },

...
*/
	...
	JSONArray QuotaConsumeArrayJSON = new JSONArray();
	...
	if(partyLoomDetails){
		...
		Debug.log("tenPerValue=================="+tenPerValue);
		
		Debug.log("invoiceValue=================="+invoiceValue);*/
		
		}
	}
	
	tempData.put("QuotaConsumeArrayJSON", QuotaConsumeArrayJSON);

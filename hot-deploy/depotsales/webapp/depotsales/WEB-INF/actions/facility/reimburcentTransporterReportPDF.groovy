...
condList = [];
//condList.add(EntityCondition.makeCondition("invoiceId", EntityOperator.EQUALS, "10597"));
...
for (eachPartyId in partyIds) {
	...
	//Debug.log("OrderItemBilling======================"+OrderItemBilling);
	 ...
	 //Debug.log("OrderRoleList=========232323========"+OrderRoleList);
	 ...
	 if(shipmentId){
		 ...
		 //Debug.log("shipmentList=========34343========"+shipmentList);

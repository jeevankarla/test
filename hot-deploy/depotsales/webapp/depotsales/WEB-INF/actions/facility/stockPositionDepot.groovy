...
import in.vasista.vbiz.purchase.MaterialHelperServices;
 ...
 if(UtilValidate.isNotEmpty(inventoryItemList)){
	 ...
	 if(UtilValidate.isNotEmpty(inventoryItemVarianceList)){
	 inventoryItemVarianceList.each{inventoryItemVariance->
		 tempQty=inventoryItemVariance.quantityOnHandVar;

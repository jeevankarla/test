...
hasChequePermission = security.hasEntityPermission("DEPOTSALES", "_CHEQUE", session);
if(hasChequePermission){
	context.paymentMethodTypeId = "CHEQUE_PAYIN";
	context.subTabItem = "ChequePayment";
}
hasChallanPermission = security.hasEntityPermission("DEPOTSALES", "_CHALLAN", session);
if(hasChallanPermission){
	context.paymentMethodTypeId = "CHALLAN_PAYIN";
	context.subTabItem = "ChallanPayment";
}
hasCashPermission = security.hasEntityPermission("DEPOTSALES", "_CASH", session);

	...
	DecimalFormat df = new DecimalFormat("0.00");
	 for(Map.Entry entry : DataMap.entrySet()){
	 		...
	 		if (branchROMap.containsKey(partyId)) {
				...
				newObj.put("ro","");
				newObj.put("avgTAT","");
				newObj.put("indentQty",df.format((entryValue.get("totQty")/100000)));
				newObj.put("totalRevenue", df.format((entryValue.get("totRevenue")/100000)));
				newObj.put("totPurchases", entryValue.get("totPurchases"));
				newObj.put("totalPoQty",df.format((entryValue.get("poQty")/100000)));
				newObj.put("totalPoAmt", df.format((entryValue.get("poAmt")/100000)));

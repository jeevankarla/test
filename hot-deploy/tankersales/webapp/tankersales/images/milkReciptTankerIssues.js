...
$(function() {
    $('#submitEntry').click (function (){
    	...
    	var action = "createMilkTankerReceiptEntryTS";
    	if(displayScreen == "ISSUE_TARWEIGHT"){
    		if(!$("#milkReceiptEntry").validate({messages:{
    			tareDate:"" , tareTime:"" , tareWeight:"" 
      	   }}).form()) return;
    		
    		action = "updateInternalMilkTransferTareWeightTS";
    	}else if(displayScreen == "LOADING_DETAILS"){
     		action = "createShipmentForTankerSalesOrder";
     	}else if(displayScreen == "ISSUE_CIP"){
     		action = "updateTankerSalesCIP";
    		...
    		action = "updateInternalMilkTransferGrsWeightTS";
    		...
    		action = "updateInternalMilkTransferQCTS";
    	}else if(displayScreen == "ISSUE_AQC"){
    		
    		action = "updateInternalMilkTransferAQCTS";
        	...
        	if(!$("#milkReceiptEntry").validate({messages:{
         	...
         	if(!$("#milkReceiptEntry").validate({messages:{
        	  ...
        	  //$("#milkReceiptEntry").form()
        	  
    		//if(!$("#milkReceiptEntry").form()) return;
    	}

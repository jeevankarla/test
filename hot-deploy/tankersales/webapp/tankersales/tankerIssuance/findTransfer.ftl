...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <#else>
 		<form method="post" name="findMilkReceipts" id="findMilkReceipts" action="<@ofbizUrl>TankerSalesToApprove</@ofbizUrl>">  
 		</#if>
	          	...
	          	<table>
	          		<tr>
	          			<table>
                         	...
                         	<tr>
		                         		<td><span class='h3'>From Party: </span></td><td>

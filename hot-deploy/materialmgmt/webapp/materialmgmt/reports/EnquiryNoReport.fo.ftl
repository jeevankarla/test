           ...
           <fo:static-content font-size="13pt" font-family="Courier,monospace"  flow-name="xsl-region-before" font-weight="bold">
              ...
              <fo:block text-align="center" keep-together="always"  >&#160;---------------------------------------------------------------------------------------------------</fo:block>
                ...
                <fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">				        
				   <fo:block text-align="left" keep-together="always" white-space-collapse="false">&#160; ENQUIRY NO.: ${parameters.issueToEnquiryNo}                                                          </fo:block>	
				   <fo:block font-family="Courier,monospace">
					     ...
					     <#list partyDetList as partyNameList>
					      <fo:table-column column-width="140pt"/>					      
					         ...
					         <fo:table-body>
					             <fo:table-row>
					                 <fo:table-cell >
								        <fo:block text-align="center" keep-together="always" font-weight="bold">VENDOR NAME</fo:block>
					                 ...
					                 <#list partyDetList as partyNameList>
    										<fo:table-cell border-style="solid">
						                      <fo:block text-align="center" font-size="13pt" white-space-collapse="false" font-weight="bold">${partyNameList.get("partyName")?if_exists}</fo:block>
						                  	</fo:table-cell>
    									</#list>    	
					             </fo:table-row> 
					             <fo:table-row>
				     ...
				     <fo:block font-family="Courier,monospace">
					     ...
					     <fo:table-column column-width="140pt"/>
					         ...
					         <fo:table-body>					         
                           		<#assign prodList = prodNameMap.entrySet()>
                           	     <#if prodList?has_content>                           	     
		  					     <#list prodList as productEntry>   
                           		 <#assign productId=productEntry.getKey()>
                           		  <#assign productEntryValue=productEntry.getValue()>
                                <fo:table-row>
		  					        <fo:table-cell border-style="solid">
		  					            <fo:block text-align="center" font-size="10pt" >${productEntryValue.get("productName")?if_exists}</fo:block>
		  					        </fo:table-cell> 
		  					         <fo:table-cell border-style="solid">
		  					            <fo:block text-align="center" font-size="10pt" >${productEntryValue.get("quantity")?if_exists}</fo:block>
		  					        </fo:table-cell>
		  					        <fo:table-cell border-style="solid">
		  					        ...
		  					        <fo:table-cell border-style="solid" >
		  					            <fo:block text-align="center" font-size="10pt" >${pList.getValue().get("price")?if_exists}/${pList.getValue().get("amount")?if_exists}</fo:block>
		  					        </fo:table-cell> 
		  					        <#else>
		  					        <fo:table-cell border-style="solid" >
		  					            <fo:block text-align="center" font-size="10pt" >fgdfgdf</fo:block>
		  					        </fo:table-cell> 
		  					        </#if>
		  					         </#list> 		  					        	  					    
					           </fo:table-row> 					               				             
	                    ...
	                    <fo:table>
					      ...
					      <fo:table-column column-width="140pt"/>
					          ...
					          <fo:table-body>
					              ...
					              <fo:table-row>
					                  <fo:table-cell border-style="solid">
					                      <fo:block text-align="center" font-size="10pt" font-weight="bold">${quoteList.get("termTypeId")?if_exists}</fo:block>
					                  </fo:table-cell>
					                 <#list partyDetList as partyNameList>
    										<fo:table-cell border-style="solid">
					                      		<fo:block text-align="center" font-size="10pt" font-weight="bold">${quoteList.get("termValue")?if_exists}</fo:block>
					                 		</fo:table-cell>
    									</#list> 					                
					             </fo:table-row>
					             </#list> </#if>					              
				   ...
				   <fo:block linefeed-treatment="preserve">&#xA;</fo:block>		        
				   <fo:block linefeed-treatment="preserve">&#xA;</fo:block>		        				   
                   <fo:block text-align="left" keep-together="always"  font-weight="bold" white-space-collapse="false">Vendor Name</fo:block>
			       <#list partyDetList as partyNameList>
						 <fo:block text-align="left" font-size="10pt" font-weight="bold">${partyNameList.get("partyName")}</fo:block>
    				</#list>   
				   <fo:block linefeed-treatment="preserve">&#xA;</fo:block>		        
				   <fo:block linefeed-treatment="preserve">&#xA;</fo:block>		        

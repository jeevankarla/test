...
<#escape x as x?xml>
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
		...
		<fo:page-sequence master-reference="main">
			...
			<fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" >STORE:    <fo:inline font-weight="bold">${parameters.issueToFacilityId?if_exists}</fo:inline></fo:block>	
			 ...
			 <fo:table>
					...
					<fo:table-body>	
                     ...
                     <fo:table-row>
		                ...
		                <fo:table-cell><fo:block text-align="left" > ${products.get("productName")?if_exists}</fo:block> </fo:table-cell>                         							
		                <fo:table-cell><fo:block text-align="left" > ${products.get("unit")?if_exists}</fo:block> </fo:table-cell> 
              		    <fo:table-cell><fo:block text-align="right"> ${products.get("quantity")?if_exists}</fo:block> </fo:table-cell>                         														
                 ...
                 <fo:table-row>
	    		    ...
	    		    <fo:table-cell><fo:block text-align="right" keep-together="always"> ${Category.getKey()?if_exists} TOTAL </fo:block> </fo:table-cell>
	    		    <fo:table-cell><fo:block text-align="right"> </fo:block> </fo:table-cell>                         							

...
<#escape x as x?xml>
	<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        ${setRequestAttribute("OUTPUT_FILENAME", "ScrapDCandGatePassReport.pdf")}
<#if finalMap?has_content>
        <fo:page-sequence master-reference="main" font-size="12pt">	
        	<fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace">
             		...
             		<fo:table>
			            ...
			            <fo:table-body>
			                <fo:table-row>
                                ...
                                <fo:table-cell>
					            	<fo:block  keep-together="always" text-align="left" font-size="11pt" white-space-collapse="false">GR NO</fo:block>  
					            </fo:table-cell>
                                <fo:table-cell>
					            	<fo:block  keep-together="always" text-align="left" font-size="11pt" white-space-collapse="false">GR DATE</fo:block>  
					            </fo:table-cell>
                                <fo:table-cell>
             ...
             <#assign scrapDcValues=finalMap.entrySet()>  
        	<#assign sno=1>
        	<fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">	
			<fo:block linefeed-treatment="preserve">&#xA;</fo:block>  
			<#list  scrapDcValues as productValues>
             		...
             		<fo:table>
			            ...
			            <fo:table-body>
			                <fo:table-row>
                                ...
                                <fo:table-cell>
					            	<fo:block  keep-together="always" text-align="left" font-size="11pt" white-space-collapse="false"><#if payment.paymentId?has_content>${payment.paymentId?if_exists}</#if></fo:block>  
					            </fo:table-cell>
                                <fo:table-cell>
					            	<fo:block  keep-together="always" text-align="left" font-size="11pt" white-space-collapse="false"><#if payment.paymentDate?has_content>${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(payment.paymentDate, "dd/MM/yyyy")}</#if></fo:block>  
					            </fo:table-cell>
                                <fo:table-cell>

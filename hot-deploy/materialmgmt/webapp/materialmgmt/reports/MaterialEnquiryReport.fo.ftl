		...
		<#if partyAddressMap?has_content>
			<fo:page-sequence master-reference="main">
			    <fo:static-content font-size="13pt" font-family="Courier,monospace"  flow-name="xsl-region-before" font-weight="bold">
					      ...
					      <fo:table-column column-width="120pt"/>
					          ...
					          <#assign sno=1>
				                  <fo:table-row >
								   ...
								   <fo:table-cell >
									  <fo:block text-align="left" keep-together="always" >${enquiryMap.get("quantityUomId")?if_exists}</fo:block>
								   </fo:table-cell>
								   <fo:table-cell >
	               ...
	               <fo:block  font-size="12pt" keep-together="always"  white-space-collapse="false"  text-align="left">&#160;2.All statutary taxes,duties,levies and other expenditure, should be clearly indicated with breakup.</fo:block>

...
<fo:page-sequence master-reference="main" force-page-count="no-force" font-family="Courier,monospace">					
		   ...
		   <fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false">&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Date     : ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(nowTimestamp, "dd/MM/yy HH:mm:ss")}</fo:block> 
		     ...
		     <fo:block  keep-together="always" text-align="left" font-weight="bold" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" >&#160;               KARNATAKA CO-OPERATIVE MILK PRODUCERS FEDERATION LTD.          Page No : <fo:page-number/></fo:block>
			       <fo:block  keep-together="always" text-align="center" font-weight="bold" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" > &#160;&#160;                                                                </fo:block>
					<fo:block  keep-together="always" text-align="center" font-weight="bold" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" >  UNIT : MOTHER DAIRY:G.K.V.K POST : YELAHANKA:BANGALORE : 560065  </fo:block>
			        <fo:block  keep-together="always" text-align="center" font-weight="bold" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" > ----------------------------------------------------------------  </fo:block>
                    <fo:block text-align="center" font-size="12pt" font-weight="bold"  font-family="Courier,monospace"  keep-together="always"  white-space-collapse="false" >&#160;&#160;STATEMENT SHOWING THE DETAILS OF STORES STOCK POSITION ON :  ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(nowTimestamp, "dd/MM/yyyy")}  </fo:block>
  			        <fo:block  keep-together="always" text-align="center" font-weight="bold" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" > &#160;&#160;  </fo:block>
 ...
 <fo:block >
              		...
              		<fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false" font-size="10pt" >______________________________________________________________________________________________________________</fo:block>
              	    <fo:block  font-size="10pt" keep-together="always"  font-family="Courier,monospace"  white-space-collapse="false" font-weight="bold" > LEDGER          ITEM             DESCRIPTION                    UNIT       BOOK         CLOSING       CLOSING  </fo:block>
              		<fo:block  font-size="10pt" keep-together="always"  font-family="Courier,monospace"  white-space-collapse="false" font-weight="bold" >  FOLIO           CODE                                                   STOCK(Inc QC) STOCK(Inc QC)  STOCK VALUE</fo:block>
              		<fo:block  keep-together="always" text-align="left" font-family="Courier,monospace" white-space-collapse="false" font-size="10pt" >______________________________________________________________________________________________________________</fo:block>               
                   ...
                   <fo:table-row>
                      <fo:table-cell ><fo:block text-align="left"   font-size="10pt" keep-together="always">&#160;</fo:block></fo:table-cell>     
                	   ...
                	   <fo:table-cell ><fo:block text-align="left"   font-size="11pt" >&#160;${productIds.ledgerfolio?if_exists}</fo:block></fo:table-cell>     
  				       ...
  				       <fo:table-cell ><fo:block text-align="right" keep-together="always"  font-size="11pt" >${productIds.closingQty?if_exists}</fo:block></fo:table-cell>     
  				       <fo:table-cell ><fo:block text-align="right"  keep-together="always" font-size="11pt" >${productIds.closingQty?if_exists}</fo:block></fo:table-cell>
                       <fo:table-cell ><fo:block text-align="right"  keep-together="always" font-size="11pt" >${productIds.openingTotCost?if_exists?string("##0.00")}</fo:block></fo:table-cell>                                
  				     </fo:table-row>
     </#list>
  	  <#assign sNo=sNo+1>
       </#list>             

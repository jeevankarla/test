...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
	...
	<#else>
       <#if prchaseCategorySummeryMap?has_content>
         	<#if parameters.reportNameFlag?exists && "CategoryWise"==parameters.reportNameFlag>
		...
		<#-- catagory wise Ends here -->
		
		
		<#-- ProductWise starts here -->
		
		
		<#elseif parameters.reportNameFlag?exists && "ProductWise"==parameters.reportNameFlag>
	    <fo:page-sequence master-reference="main" font-size="12pt">
		<fo:static-content flow-name="xsl-region-before">
			<fo:block keep-together="always" text-align="right"
				font-family="Courier,monospace" white-space-collapse="false"> &#160;${uiLabelMap.CommonPage}- <fo:page-number />
		                     ...
		                     <#assign totalAssCstRevenue=0>
								...
								<fo:table-cell number-columns-spanned="6">
									<fo:block keep-together="always" text-align="left"
          						   ...
          						   <#if productDetailMap?has_content>
          						   <#assign productDetailList= productDetailMap.entrySet()>
								...
								<fo:table-cell number-columns-spanned="6">
									<fo:block keep-together="always" text-align="left"
          						   ...
          						   <#assign innerProductDetailList=innerProductDetailMap.get("prodInvItemList")>
          						    <#list innerProductDetailList as invTaxMap>
							    ...
							    <fo:table-cell>
									<fo:block keep-together="always" text-align="right"
          						     ...
          						     <fo:table-row>
										...
										<fo:table-cell>
											<fo:block keep-together="always" text-align="right"
												font-size="11pt" white-space-collapse="false">${(innerProductDetailMap.get("totalValue"))?string("#0.00")}</fo:block>
										</fo:table-cell>
									   </fo:table-row>
          						    </#list>
          						   </#if>

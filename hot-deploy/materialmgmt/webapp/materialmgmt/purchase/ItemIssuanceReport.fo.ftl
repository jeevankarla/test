	...
	<#if itemIssuanceList?has_content>
			...
			<#assign partyGroup = delegator.findOne("PartyGroup",{"partyId" :fromPartyId}, true)>
     		<fo:static-content flow-name="xsl-region-before">
        		...
        		<fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" font-weight="bold" >  &#160; </fo:block>
        		<fo:block white-space-collapse="false" keep-together="always" font-family="Courier,monospace"  font-size="12pt">&#160;                               SUB : ISSUE OF MATERIALS                          </fo:block>
        		<fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-size="12pt" font-weight="bold" >  &#160; </fo:block>
          ...
          <fo:flow flow-name="xsl-region-body" font-family="Courier,monospace" font-size="11pt">
           		<fo:block>
           			<fo:table>
       					 ...
       					 <fo:table-column border="solid" column-width="300pt"/>
       					 ...
       					 <fo:table-body>
       					 	<fo:table-row >
       					 		...
       					 		<fo:table-cell text-align="center" border="solid"><fo:block>ISSUANCE ID</fo:block></fo:table-cell>
       					 		...
       					 		<fo:table-cell text-align="center" border="solid"><fo:block>ISSUED QTY</fo:block></fo:table-cell>
       					 		<fo:table-cell text-align="center" border="solid"><fo:block>LEDGER NO</fo:block></fo:table-cell>
       					 	</fo:table-row>
       					 	<#assign sno=1>
						<#list itemIssuanceList as indent>
							<fo:table-row >
                                ...
                                <fo:table-cell text-align="center" ><fo:block>${indent.get("itemIssuanceId")?if_exists}</fo:block></fo:table-cell>

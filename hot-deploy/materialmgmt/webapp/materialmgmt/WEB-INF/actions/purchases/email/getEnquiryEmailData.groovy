...
emailAddress="";
	...
	GenericValue tenantConfigSendCc = delegator.findOne("TenantConfiguration", UtilMisc.toMap("propertyTypeEnumId","PURCHASE_OR_STORES", "propertyName","sendCcMailId"), false);
	if (UtilValidate.isNotEmpty(tenantConfigSendCc)) {
		sendCcEmail=tenantConfigSendCc.getString("propertyValue");
	}
	
	JSONObject emailData = new JSONObject();
	emailData.put("sendToEmail",emailAddress);
	emailData.put("sendFromEmail",sendFromEmail);
	emailData.put("sendCcEmail",sendCcEmail);

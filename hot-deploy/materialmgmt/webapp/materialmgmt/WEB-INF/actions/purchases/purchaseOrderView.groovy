...
// FaxNumber
	   ...
	   conditionListAddress.add(EntityCondition.makeCondition("partyId", EntityOperator.EQUALS, fromPartyId));
	   cond=EntityCondition.makeCondition(conditionListAddress,EntityOperator.AND);
	   faxNumber="";

...
<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="main" page-height="12in" page-width="16.5in"
      		...
      		<#assign boothWiseTotalList =boothWiseTotalMap.entrySet()>
		    <#if boothWiseTotalList?has_content>  
		    	<#list boothWiseTotalList as boothWiseEntries>
			        <fo:page-sequence master-reference="main">
			        	<fo:static-content flow-name="xsl-region-before">
			        		...
			        		<fo:block text-align="center" font-family="Helvetica" white-space-collapse="false" font-size="13pt" keep-together="always" font-weight="bold">AGENT WISE DAILY SALES AND COLLECTION REPORT</fo:block>
			        		<#-- <fo:block text-align="center" font-family="Helvetica" white-space-collapse="false" font-size="12pt" keep-together="always" font-weight="bold">&#160;                                                                                                                        Date   ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(nowTimestamp, "dd-MMM-yyyy")}</fo:block>      -->                                             
			        		<#assign routeDetails = delegator.findOne("Facility", {"facilityId" : parameters.routeId}, true)>
			        	    ...
			        	    <#assign facilityDetails = delegator.findOne("Facility", {"facilityId" : boothWiseEntries.getKey()}, true)>
			        		<fo:block white-space-collapse="false" font-size="12pt"  font-family="Helvetica" keep-together="always" >&#160;   AGENT CODE :${boothWiseEntries.getKey()?if_exists}&#160;    &#160;     &#160;   AGENT NAME  :${facilityDetails.get("description")?if_exists}</fo:block>
			        		<fo:block >
			        			 <fo:table width="100%" table-layout="fixed" border-style="solid" font-size="10pt">
						            ...
						            <fo:table-column column-width="50pt"/>
				                     ...
				                     <fo:table-cell border-style="solid"><fo:block text-align="center" keep-together="always" >SALE DATE</fo:block></fo:table-cell>       		
				                       <#list lmsProductList as product>                       		
				                       		<fo:table-cell border-style="solid">
				                       			<fo:block keep-together="always" text-align="center" white-space-collapse="false"  font-weight="bold">${product.brandName?if_exists}</fo:block>
				                       		</fo:table-cell>
				                       	</#list>
				                     </fo:table-row>
				                       ...
				                       <#list byProductsList as product>                       		
				                       	<fo:table-cell  border-style="solid">
				                       			<fo:block  text-align="center" white-space-collapse="false"  font-weight="bold">${product.brandName?if_exists}</fo:block>
				                       	</fo:table-cell>
				                       	</#list>				                       			                       	
				                       	<fo:table-cell border-style="solid">
			       		...
			       		<fo:flow flow-name="xsl-region-body" font-family="Helvetica">
			        		<fo:block >
			        			 <fo:table width="100%" table-layout="fixed" border-style="solid" font-size="10pt">
			       			    ...
			       			    <#assign agentWiseList = boothWiseEntries.getValue().entrySet()>
			       			  <#assign sno=1>
			       			  <#list agentWiseList as agentWiseEntries>
			       			    ...
			       			    <#if productList.getKey()=="LMS">
			                       	...
			                       	<fo:table-cell border-style="dotted"><fo:block text-align="left" font-weight="bold" font-size="10pt" keep-together="always">${agentWiseEntries.getKey()?if_exists}</fo:block></fo:table-cell>
				                  ...
				                  <#if productList.getKey()=="BYPROD">
			                       ...
			                       <#assign grandTotalList=(boothWiseGrandTotalMap.get(boothWiseEntries.getKey())).entrySet()>

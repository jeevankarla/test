...
<script type="application/javascript">					 
	...
	function showTruckSheetGenerateForm() {	
		var message = "";
		message += "<form method='post' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10>" ; 		
		
			//message += "<br/><br/>";	
			message += "<tr class='h3'><td align='left' class='h3' width='40%'><input type='hidden' id='shipmentTypeId' name='shipmentTypeId' value='AM_SHIPMENT'/>Supply Date:</td><td align='right' width='60%'><input class='h3' type='text' id='estimatedDeliveryDate' name='estimatedDeliveryDate' onmouseover='datepick()' size='13'/>" +

...
def populateChildren(facility, treeNodesList, enableEdit) {
	...
	boothMembers = delegator.findList("FacilityGroupMember", EntityCondition.makeCondition("facilityGroupId", EntityOperator.EQUALS, facility.facilityGroupId), null, null, null, false);

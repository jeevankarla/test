...
*/
	...
	while (mapIter.hasNext()) {
		...
		newDailyIndent.set("routeid",facilityRetailerMap[indentValue.get("routeId")]);
		newDailyIndent.set("retailerid",facilityRetailerMap[boothId]);
		newDailyIndent.set("idId","30000000");
		Debug.log("newDailyIndent==========="+newDailyIndent);
		try{
		...
		for(GenericValue product :productList){
			...
			newDailyIndentDetail.set("quantity", indentValue.get(product.get("productId")));

...
<fo:page-sequence master-reference="main" force-page-count="no-force" font-family="Courier,monospace">					
			<fo:static-content flow-name="xsl-region-before">
					...
					<fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false" font-weight="bold" font-size="9pt">DISTRIBUTION TRANSPORTATION COST PER LTR OF MILK SOLD BETWEEN ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(fromDateTime, "MMMM/dd/yyyy")} to ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(thruDateTime, "MMMM/dd/yyyy")}</fo:block>
              		<fo:block font-size="8pt">------------------------------------------------------------------------------------------------------------</fo:block>
              		<fo:block font-size="9pt" font-weight="bold">Route No    								&#160;&#160;Total Sales  					&#160;&#160;&#160;&#160;Avg Sales  			&#160;&#160;Distance Per Day  			&#160;&#160;&#160;&#160;&#160;Rate  			&#160;&#160;&#160;&#160;&#160;Cost Per Day     &#160;&#160;&#160; Cost/Ltr</fo:block>
            		<fo:block font-size="8pt">------------------------------------------------------------------------------------------------------------</fo:block>
            </fo:static-content>		
            <fo:flow flow-name="xsl-region-body"   font-family="Courier,monospace">		
            	<fo:block>
                    ...
                    <#assign routeDetails = dTCCostMap.entrySet()>
                    ...
                    <#if (totalDays!=0)>
                    	<#assign averageSaleQty = (saleQty/totalDays)>
                    </#if>
                    ...
                    <#assign totalPayment = totalPayment+payment>	
						<fo:table-row>
                				<fo:table-cell>
                            		<fo:block  keep-together="always" text-align="left"  white-space-collapse="false">${eachRoute.getKey()?if_exists}</fo:block>  
                       			</fo:table-cell>
                       			<fo:table-cell>
                            		<fo:block  text-align="right"  white-space-collapse="false">${saleQty?if_exists?string("#0.00")}</fo:block>  
                       			</fo:table-cell>
                       			<fo:table-cell>
                            		<fo:block  text-align="right"  white-space-collapse="false"><#if (totalDays!=0)>${(saleQty/totalDays)?if_exists?string("#0.00")}</#if></fo:block>  
                       			</fo:table-cell>
                       			 <#if facilitySize?has_content>
                       			<fo:table-cell>

                                ...
                                <tr<#if itemClass == "1"> class="alternate-row"</#if>>
                                    <td align="right" colspan="2">
                                        ...
                                        <#if orderItemAdjustment.productPromoId?has_content>
                    				  	...
                    				  	<#assign orderItemAdjustmentType = orderItemAdjustment.getRelatedOneCache("OrderAdjustmentType")/>
                    				  	<#if orderItemAdjustmentType.parentTypeId == "SALES_TAX">                                        

...
<fo:page-sequence master-reference="main" force-page-count="no-force" font-family="Courier,monospace">					
			<fo:static-content flow-name="xsl-region-before">
                    ...
                    <fo:block text-align="left" font-size="12pt" keep-together="always"  white-space-collapse="false">&#160;        Product Returns  Report :: ${effectiveDateStr?if_exists}</fo:block>
              		<fo:block font-size="8pt">----------------------------------------------------------------------------------------------------------------------------------------</fo:block>
              		<fo:block font-size="8pt">&#160;&#160;Date    								&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;Route  					&#160;&#160;&#160;&#160;&#160;&#160;Retailer  			&#160;&#160; 	ShipmentType  			&#160;&#160;&#160;&#160;&#160;&#160;	ProductName  			&#160;&#160;&#160;&#160; ReturnQuantity     &#160;&#160;&#160;&#160; Reason			&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;UserLogin</fo:block>
            		<fo:block font-size="8pt">----------------------------------------------------------------------------------------------------------------------------------------</fo:block>
            </fo:static-content>		
            	...
            	<fo:block>
                    ...
                    <fo:table-body>
                    	<#list returnProductList as returnItem>
								...
								<fo:table-row>
                    				<fo:table-cell>
	                            		<fo:block  keep-together="always" text-align="left"  white-space-collapse="false">${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(returnItem.get("date"), "dd-MMM-yyyy")}</fo:block>  
	                       			</fo:table-cell>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  white-space-collapse="false">${returnItem.get("routeId")}</fo:block>  
	                       			</fo:table-cell>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  white-space-collapse="false">${returnItem.get("boothId")}</fo:block>  
	                       			</fo:table-cell>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  white-space-collapse="false">${returnItem.get("shipmentTypeId")?if_exists}&#160;</fo:block>  
	                       			</fo:table-cell>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  white-space-collapse="false">${product.brandName?if_exists}</fo:block>  
	                       			</fo:table-cell>
	                       			<fo:table-cell>

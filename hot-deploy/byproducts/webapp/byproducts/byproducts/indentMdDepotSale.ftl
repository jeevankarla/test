...
<#include "indentMdDepotSaleInc.ftl"/>
<#include "indentMdDepotUdpEdit.ftl"/>
<#--
<#assign initAction =''>	
...
<div class="screenlet">
	...
	<#if booth?exists || party?exists>
    	...
    	<div align="center">
    		...
    		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    		<input type="submit" style="padding:.3em" id="changeCancel" value="Cancel" onclick="javascript:processIndentEntry('indententry','<@ofbizUrl>DepotSale</@ofbizUrl>');"/>   	
    	</div>     
	</#if>  
	</div>
</div>     

...
function updateGrid(){
	...
	var action = "getRouteIssuanceDetailsJson";	
		...
		$.ajax({
				...
				success:function(result){
					if(result["_ERROR_MESSAGE_"] || result["_ERROR_MESSAGE_LIST_"]){
					    ...
					    $('div#changeIndentEntry_spinner').html('');
						var routeProductList = result["routeProductList"];
...
//end of update grid
	...
	var _grid;
	 function setupGrid1(ajaxJson) {
		...
		var columns = [
			{id:"cProductName", name:"Product", field:"cProductName", width:150, minWidth:150, cssClass:"cell-title", availableTags: availableTags, editor: AutoCompleteEditor, validator: productValidator,sortable:false ,toolTip:""},
			{id:"cQuantity", name:"Quantity", field:"cQuantity", width:120, minWidth:120, cssClass:"cell-title",editor:FloatCellEditor, sortable:false , formatter: quantityFormatter,  validator: quantityValidator}
		];
	...
	<#if (showBoothAutoSuggest?has_content) && (showBoothAutoSuggest != 'N') && !parameters.routeChange?exists && !parameters.routeChange?has_content>

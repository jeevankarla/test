...
<div class="screenlet">
    <div class="screenlet-title-bar">
        <ul>
            <li class="h3">${uiLabelMap.ProductAddItemsShipment}: [${shipmentId?if_exists}]; ${uiLabelMap.ProductFromAnOrder}: [${orderId?if_exists}]</li>
        </ul>
        <br class="clear"/>
    </div>
    ...
    <#if orderItemDatas?exists>
        <#assign rowCount = 0>
        <#if isSalesOrder>
            <form action="<@ofbizUrl>ShipOrderItemsForIndent</@ofbizUrl>" method="post" name="selectAllForm">
        <#--<#else>byProdIssueOrderItemShipGrpInvResToShipment
                    ...
                    <#else>
                        ...
                        <#if (quantityNotIssued > 0)>
                            <td>
                                ...
                                <input type="text" size="5" name="quantity_o_${rowCount}" id="quantity_o_${rowCount}" value="${quantityNotIssued}"/>
                            </td>
                            <td align="right">
                              <input type="checkbox" name="_rowSubmit_o_${rowCount}" value="Y" onclick="javascript:checkToggle(this, 'selectAllForm');hideTextBox(this, 'quantity_o_${rowCount}');highlightRow(this,'orderItemData_tableRow_${rowCount}');" />
                            </td>
                        ...
                        <tr id="orderItemData_tableRow_${rowCount}">
                            ...
                            <#if originFacility?exists && originFacility.facilityId == inventoryItem.facilityId?if_exists>
                                <td>
                                    ...
                                    <input type="text" size="5" name="quantity_o_${rowCount}" id="quantity_o_${rowCount}" value="${(orderItemShipGrpInvResData.shipmentPlanQuantity)?default(availableQuantity)}"/>
                                </td>
                                <td align="right">
                                  <input type="checkbox" name="_rowSubmit_o_${rowCount}" value="Y" onclick="javascript:checkToggle(this, 'selectAllForm');hideTextBox(this, 'quantity_o_${rowCount}');highlightRow(this,'orderItemData_tableRow_${rowCount}');" />
                                </td>
        ...
        <script language="JavaScript" type="text/javascript">
        	function hideTextBox(element,id) {

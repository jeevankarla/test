...
*/								 
	...
	function showUDPPriceToolTip(gridRow, index) {
		...
		if(priceExists == "N"){
			message += "<tr class='h3'><td align='left'>Basic Price : </td><td align='right'><input type='text' name='amount' id='basicAmount'  onblur='updateProdTaxPrice()' /></td></tr>";
			message += "<tr class='h3'><td align='left'>BED % : </td><td><input type='text' name='bedPercent' id='bedPercent' onblur='getBedAmount();' readonly='true' /></td><td align='left'>BED Amount : </td><td><input type='text' name='bedAmount' id='bedAmount' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>VAT %: </td><td><input type='text' name='vatPercent' id='vatPercent' onblur='getVatAmount();' readonly='true' /></td><td align='left'>VAT Amount : </td><td><input type='text' name='vatAmount' id='vatAmount' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>CST % : </td><td><input type='text' name='cstPercent' id='cstPercent' onblur='getCstAmount();' readonly='true' /></td><td align='left'>CST Amount : </td><td><input type='text' name='cstAmount' id='cstAmount' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>TCS % : </td><td><input type='text' name='tcsPercent' id='tcsPercent' onblur='getTcsAmount();' readonly='true' /></td><td align='left'>TCS Amount : </td><td><input type='text' name='tcsAmount' id='tcsAmount' readonly='true'></td></tr>";
		    ...
		    message += "<tr class='h3'><td align='left'>Basic Price : </td><td align='right'><input type='text' name='amount' id='basicAmount'  onblur='updateProdTaxPrice()'  value='"+basicPrice+"'  /></td></tr>";
			message += "<tr class='h3'><td align='left'>BED % : </td><td><input type='text' name='bedPercent' id='bedPercent' value='"+bedPercent+"' onblur='getBedAmount();' readonly='true' /></td><td align='left'>BED Amount : </td><td><input type='text' name='bedAmount' id='bedAmount' value='"+bedPrice+"' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>VAT %: </td><td><input type='text' name='vatPercent' id='vatPercent' value='"+vatPercent+"' onblur='getVatAmount();'  readonly='true' /></td><td align='left'>VAT Amount : </td><td><input type='text' name='vatAmount' id='vatAmount' value='"+vatPrice+"' readonly='true' ></td></tr>";
			message += "<tr class='h3'><td align='left'>CST % : </td><td><input type='text' name='cstPercent' id='cstPercent' value='"+cstPercent+"' onblur='getCstAmount();' readonly='true' /></td><td align='left'>CST Amount : </td><td><input type='text' name='cstAmount' id='cstAmount' value='"+cstPrice+"' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>TCS % : </td><td><input type='text' name='tcsPercent' id='tcsPercent' value='"+tcsPercent+"' onblur='getTcsAmount();' readonly='true' /></td><td align='left'>TCS Amount : </td><td><input type='text' name='tcsAmount' id='tcsAmount' value='"+tcsPrice+"' readonly='true'></td></tr>";
			message += "<tr class='h3'><td align='left'>Service Percent : </td><td><input type='text' name='serviceTaxPercent' id='serviceTaxPercent' value='"+serviceTaxPercent+"' onblur='getServiceTaxAmount();' readonly='true' /></td><td align='left'>Service Tax Amount : </td><td><input type='text' name='serviceTaxAmount' id='serviceTaxAmount' value='"+serviceTaxPrice+"' readonly='true' /></td></tr>";
			<#--

                    	...
                    	<#list productDetails as prodTotals>
								...
								<fo:table-row>
                    				<fo:table-cell>
	                       			...
	                       			<#else>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  font-size="12pt" white-space-collapse="false">${quantity?if_exists?string("#0.00")}</fo:block>  
	                       			</fo:table-cell>
	                       			</#if>
	                       			...
	                       			<#else>
	                       			<fo:table-cell>
	                            		<fo:block  text-align="right"  font-size="12pt" white-space-collapse="false">${qtyLtrsKgs?if_exists?string("#0.00")}</fo:block>  
	                       			</fo:table-cell>
	                       			</#if>

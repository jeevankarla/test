...
<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        <fo:layout-master-set>
            <fo:simple-page-master master-name="main" page-height="12in" page-width="12in"  margin-left=".3in" margin-right=".3in" margin-top=".8in">
                <fo:region-body margin-top=".6in"/>
                <fo:region-before extent="1in"/>
                <fo:region-after extent="1in"/>
            </fo:simple-page-master>
        </fo:layout-master-set>
        ${setRequestAttribute("OUTPUT_FILENAME", "ChannelWise Sales.txt")}
       <#if periodTotalsMap?has_content> 
		        <fo:page-sequence master-reference="main" font-size="10pt">	
		        	...
		        	<fo:block  keep-together="always" text-align="center" font-family="Courier,monospace" white-space-collapse="false">     </fo:block>
                    	...
                    	<fo:block text-align="left" font-size="7pt" keep-together="always"  white-space-collapse="false">TIN ::                                   PRODUCTS CHANNELWISE TOTAL SALES STATEMENT FOR THE MONTH OF :: ${parameters.customTimePeriodId}</fo:block>
              			<#-- <fo:block font-size="7pt" align-text="left">=======================================================================================================================================================================================================================================</fo:block> 
            			<fo:block text-align="left" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;SL  PROD   PRODUCT              WSD                  FRO                MCCS               DEWS               PAR&amp;FAIR                CREDIT              KFRO               AVM FRO               S.O/OTH              TOTAL </fo:block>
            			<fo:block text-align="left" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;NO  CODE    NAME          QTY        VALUE      QTY       VALUE    QTY       VALUE     QTY       VALUE      QTY       VALUE        QTY     VALUE      QTY       VALUE    QTY       VALUE       QTY        VALUE      QTY       VALUE  </fo:block>	
		        		--> 
		        		<fo:block font-size="7pt" align-text="left">=======================================================================================================================================================================================================================================</fo:block>  
		        	</fo:static-content>	        	
            	...
            	<fo:block>
            		...
            		<fo:table-header>
										...
										<fo:table-row>
				                        	...
				                        	<#list facilityCategoryList as facilityCategory>
				                        		<#if (facCatTotals.get(facilityCategory)?has_content)>
				                        			...
				                        			<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">${categoryWiseTotals.get("quantity")?string("#0")}</fo:block> 
				                        			</fo:table-cell>
				                        			<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;</fo:block> 
				                        			</fo:table-cell>
				                        			<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">${categoryWiseTotals.get("totalValue")?if_exists?string("#0.00")}&#160;</fo:block> 
				                        			</fo:table-cell>
				                        			<#assign totalQty = totalQty + (categoryWiseTotals.get("quantity"))>
				                        			<#assign totalValue = totalValue + (categoryWiseTotals.get("totalValue"))>
				                        		<#else>
				                        			<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;   &#160; </fo:block> 
				                        			</fo:table-cell>
				                        	...
				                        	<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">${totalQty?string("#0")}&#160;</fo:block> 
				                        	</fo:table-cell>
				                        	<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;</fo:block> 
				                        			</fo:table-cell>
				                        	<fo:table-cell>
				                                       <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;${totalValue?if_exists?string("#0.00")}</fo:block> 
				                        	</fo:table-cell>
										</fo:table-row>
										<fo:table-row>
	                    					<fo:table-cell>
	                	...
	                	<#-- 	<fo:table-row>
		                		...
		                		<#list facilityCategoryList as facilityCategory>
		                			<#if (grandTotalsMap.get(facilityCategory)?has_content)>
	                        			...
	                        			<fo:table-cell>
	                            			...
	                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false">${categoryWiseTotals.get("quantity")}</fo:block>  
	                        			</fo:table-cell>
	                        			<fo:table-cell>
				                                         <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;</fo:block> 
				                        </fo:table-cell>
	                        			<fo:table-cell>
	                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false"></fo:block> 
	                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false">${categoryWiseTotals.get("totalValue")}</fo:block>  
	                        			</fo:table-cell>
	                        			<#assign grandTotalQty = grandTotalQty + (categoryWiseTotals.get("quantity"))>
	                        			<#assign grandTotalValue = grandTotalValue + (categoryWiseTotals.get("totalValue"))>
	                        		<#else>
	                        			<fo:table-cell>
	                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false"></fo:block> 
	                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false"></fo:block>  
	                        	...
	                        	<fo:table-cell>
				                           <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false"></fo:block>    
				                           <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">${grandTotalQty?string("#0")}</fo:block> 
				                </fo:table-cell>
				                <fo:table-cell>
				                             <fo:block text-align="right" font-size="7pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">&#160;</fo:block> 
				                 </fo:table-cell>
	                        	<fo:table-cell>
                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false"></fo:block>
                            			<fo:block  keep-together="always" text-align="right" font-size="7pt" white-space-collapse="false">${grandTotalValue}</fo:block>  
                        		</fo:table-cell>
	                		</fo:table-row>
	                		-->
	                    </fo:table-body>

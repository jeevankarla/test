...
<script type="application/javascript">
	...
	function cancelAccountingPayments(paymentId) {
		var message = "";
		message += "<html><head></head><body><form action='cancelPaymentForChequeReturns' method='post' onsubmit='return disableGenerateButton();'><table cellspacing=10 cellpadding=10 width=400>";
			message += "<tr class='h3'><td align='left' class='h3' width='60%'>Cheque Bounce/Returns :</td><td align='left' width='60%'><select name='chequeBounce'  id='chequeBounce' onchange='javascript:chequeBounceFieldsOnchange();' class='h4'>"+
						"<option value='N' >No</option>"+  
						"<option value='Y' >Yes</option>"+          
						"</select></td></tr>"+

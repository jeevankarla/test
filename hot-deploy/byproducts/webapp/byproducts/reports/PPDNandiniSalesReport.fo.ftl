	        ...
	        <fo:page-sequence master-reference="main" font-size="12pt">	
	        	<fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace">
                	...
                	<fo:block text-align="center"  keep-together="always"  white-space-collapse="false" font-weight="bold">INVOICE NUMBER SALES REGISTER REPORT</fo:block>
          			...
          			<fo:block>------------------------------------------------------------------------------------------------------------------------------------------------</fo:block>
            	    <fo:block text-align="left" font-weight="bold" font-size="12pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">Invoice        Invoice   Central Excise 	Retailer Name        Ex-factory    			ED            VAT(Rs)   		   C.S.T(Rs)     PPD(RS)    Total(Rs)</fo:block>
        				...
        				<fo:table>
		                    ...
		                    <#assign totalRevenue=0>
		                     <#assign totalPPD=0>
       							...
       							<#assign totalPPD=totalPPD+invoiceDet.getValue().get("ppd")?if_exists>
       							...
       							<fo:table-row>
							            ...
							            <fo:table-cell>
							            	<fo:block  keep-together="always" text-align="right" font-size="12pt" white-space-collapse="false" >${invoiceDet.getValue().get("ppd")?if_exists?string("#0.00")}</fo:block>  
							            </fo:table-cell>
							            <fo:table-cell>

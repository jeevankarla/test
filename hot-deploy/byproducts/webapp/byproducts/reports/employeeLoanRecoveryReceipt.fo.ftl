		    	...
		    	<fo:static-content flow-name="xsl-region-before">
                    ...
                    <fo:table-row>
                              <#if partyName?has_content>
                				<fo:table-cell>
                            		<fo:block  text-align="left"  keep-together = "always" font-weight = "bold">From:${partyName?if_exists}(${partyId?if_exists})</fo:block>  
                       			</fo:table-cell>
                       			<#else>
                       			<fo:table-cell>
            	...
            	<fo:block>
                    ...
                    <#if newFinAccountTransId?exists>
            				...
            				<fo:table-row>
		  					...
		  					<fo:table-row>
            				     <fo:table-cell font-weight = "bold">
                    				<fo:block keep-together="always">Loan Recovery Type:</fo:block>
               					</fo:table-cell>
               					<fo:table-cell >
                    				<fo:block linefeed-treatment="preserve">&#xA;</fo:block>
               					</fo:table-cell>
               					<fo:table-cell>
               					<fo:block keep-together="always">${loanRecoveryType?if_exists}</fo:block>
               					</fo:table-cell>
		  					</fo:table-row>

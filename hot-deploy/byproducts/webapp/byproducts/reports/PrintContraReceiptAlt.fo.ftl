		    								...
		    								<fo:table-cell border-style="solid">
				                             ...
				                             <fo:table-row>
				                            	 <fo:table-cell>
	                                		 		...
	                                		 		<fo:block text-align="center" white-space-collapse="false" font-weight="bold" font-size="15pt" keep-together="always"> <#if finAccountTransTypeId == "WITHDRAWAL">PAYMENT <#else>RECEIPT </#if>VOUCHER</fo:block>
 				                             </fo:table-cell>
 				                             </fo:table-row>	
        				                   ...
        				                   <fo:table-row width="100%">
				                            ...
				                            <fo:table-cell>
						        				  ...
						        				  <fo:table-row>
						        						...
						        						<fo:table-row>
						        		                    ...
						        		                    <fo:table  table-layout="fixed" width="100%" space-before="0.2in">
			        		                    					 ...
			        		                    					 <fo:table-column column-width="20%"/>
        						   									 ...
        						   									 <fo:table-row>
        						   									  <fo:table-cell border-style="solid">
        						   									        <fo:block text-align="center" font-size="13pt" white-space-collapse="false">${finAccountName?if_exists}/</fo:block>
        						   									        <fo:block text-align="center" font-size="13pt" white-space-collapse="false" keep-together="always">${from}-${thru}/</fo:block>
						        						...
						        						<fo:table-row>
            				     							<fo:table-cell font-weight = "bold">
                    											<fo:block keep-together="always" font-size="13pt">Cheque in favour</fo:block>
               												</fo:table-cell>
               												<fo:table-cell>
               													<fo:block  font-size="13pt" keep-together="always" >:${cheqInFavour?if_exists}</fo:block>
               												</fo:table-cell>
		  												</fo:table-row>
														<fo:table-row>
            				     							<fo:table-cell font-weight = "bold">
                    											<fo:block keep-together="always" font-size="13pt">Comments</fo:block>
               												</fo:table-cell>
               												<fo:table-cell>

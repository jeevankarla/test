...
//<![CDATA[	
    ...
    function setVoidPaymentParameters(currentPayment){
        ...
        var tabValue = $(tabItemObj).val(); 
         var message = "";
                message += "<html><head></head><body><form  method='post' id='cancelPaymentDesc' action='cancelBoothPayment' onsubmit='return didsableGenerateButton();'><table cellspacing=10 cellpadding=10 width=400>";

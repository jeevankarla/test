       ...
       <#if dayWiseInvoice?has_content>
	        <fo:page-sequence master-reference="main" font-size="12pt">	
	        	<fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace">
        			...
        			<fo:block text-align="left" font-weight="bold" font-size="12pt" keep-together="always" font-family="Courier,monospace" white-space-collapse="false">Number  Seq.Number 		Name                                       (In Ltrs)       Value(Rs)           Value(Rs)                           Value</fo:block>
	        		<fo:block>-----------------------------------------------------------------------------------------------------------------------------------------------</fo:block>
            	</fo:static-content>	        	
                                ...
                                <#assign total=0>
							      ...
							      <fo:table-row>
							            ...
							            <fo:table-cell>
							             ...
							             <fo:table-cell>
							            	<fo:block   text-align="left" font-size="12pt" white-space-collapse="false" font-weight="bold">${partyName}</fo:block>  
							            </fo:table-cell>
							            	...
							            	<fo:block  font-weight="bold">
							            		<fo:table>
					                                ...
					                                <#assign totalQty=totalQty+productDtls.getValue().get("quantity")>
					       							...
					       							<#assign product = delegator.findOne("Product", {"productId" : productDtls.getKey()}, true)?if_exists/>
						                                <fo:table-row>
						                                   <fo:table-cell>
								                           		<fo:block    font-size="12pt" text-align="left" white-space-collapse="false">${product.description}</fo:block>  
								                       		</fo:table-cell>
								                       		<fo:table-cell>
								                           		<fo:block    font-size="12pt" text-align="left" white-space-collapse="false"></fo:block>  
								                       		</fo:table-cell>
															<fo:table-cell>

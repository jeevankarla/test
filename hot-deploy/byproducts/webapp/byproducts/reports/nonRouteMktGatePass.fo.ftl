			            ...
			            <fo:table-body>
			                <fo:table-row>
			                    <fo:table-cell number-columns-spanned="4">
					            	...
					            	<fo:block  keep-together="always" text-align="center" font-size="12pt" white-space-collapse="false" font-weight="bold"><#if screenFlag?has_content && screenFlag == "gatePass">GATE PASS<#else>DELIVERY CHALLAN</#if></fo:block>
								            ...
								            <fo:table-body>
								                <fo:table-row>
										            ...
										            <fo:table-cell border-style="solid">
										            	...
										            	<fo:block text-align="center" font-size="12pt" white-space-collapse="false" font-weight="bold"> CRATES</fo:block>
										            </fo:table-cell>
										            <fo:table-cell border-style="solid">
												...
												<#if orderItems?has_content>
													...
													<#list orderItems as eachItem>
														<fo:table-row>
												            ...
												            <fo:table-cell>
												            	<fo:block  keep-together="always" text-align="center" font-size="12pt" white-space-collapse="false">${eachItem.get('qtyPerCrate')?if_exists}</fo:block>  
												            </fo:table-cell>
												            <fo:table-cell>	

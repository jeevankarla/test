			               ...
			               <fo:table-body>
			                 <fo:table-row>
				                   <fo:table-cell>
				                         ...
				                         <fo:block  text-indent="15pt">RETAILER ID:&#160;${facility.get("facilityId")}</fo:block>
				                          <fo:block  text-indent="15pt">PARTY NAME:${Static["org.ofbiz.party.party.PartyHelper"].getPartyName(delegator, facility.get("ownerPartyId"), false)}</fo:block>
				                     </fo:table-cell>
				                      <fo:table-cell>
				                    ...
				                    <fo:table-cell>
				                         <fo:block>G.P.NUMBER: ${parameters.shipmentId?if_exists}</fo:block>
				...
				<fo:table>
					...
					<#-- 
						...
						<fo:table-row>
							...
							<fo:table-cell>
								<fo:block font-size="6pt" text-align="right">NET</fo:block>
    		...
    		<fo:block font-size="6pt">
				...
				<fo:table-body>
						...
						<#--<#assign amountList = shopeeRentAmount.get('amountMap').get(boothDetails.getKey())?if_exists>-->
							...
							<fo:table-cell><fo:block font-size="5pt" keep-together="always"></fo:block>

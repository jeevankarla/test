      ...
      <#if facilitySaleMap?has_content> 	    
        ...
        <fo:static-content flow-name="xsl-region-before">
		        	...
		        	<fo:block text-align="left"  keep-together="always"  font-family="Courier,monospace" font-weight="bold" white-space-collapse="false">&#160;&#160;&#160;     KARNATAKA CO-OPERATIVE MILK PRODUCERS FEDERATION LTD</fo:block>
                    	...
                    	<fo:block text-align="left"  font-family="Courier,monospace" font-weight="bold"  white-space-collapse="false">&#160;&#160;&#160;&#160;&#160;&#160;&#160;LIST OF PERMANENTLY TERMINATED RETAILERS  FOR ${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(newOrTerminateDate, "dd-MMM-yyyy")} </fo:block>
		        		...
		        		<fo:block text-align="left"  keep-together="always"  font-family="Courier,monospace" font-weight="bold" white-space-collapse="false">SRNO   	CODE	  RETAILER NAME       OPEN DATE     CLOSED DATE 	 CLOSEDTYPE					       </fo:block> 
		        		<fo:block text-align="left"  keep-together="always"   white-space-collapse="false">=========================================================================</fo:block> 
            	<fo:block>
                 	<fo:table>
					...
					<fo:table-row border-style="solid" >
                       		...
                       		<#assign sachetDetails = sachetfacility.getValue()>
                       			...
                       			<fo:table-cell border-style="solid">
                           			<fo:block  keep-together="always" text-align="left" white-space-collapse="false">${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(sachetDetails.get("opndate"), "dd-MMM-yyyy")}</fo:block>  
                       			</fo:table-cell>
                       		<fo:table-cell border-style="solid">
                           			<fo:block  keep-together="always" text-align="left" white-space-collapse="false">${Static["org.ofbiz.base.util.UtilDateTime"].toDateString(sachetDetails.get("closeddate"), "dd-MMM-yyyy")}</fo:block>  
                       			</fo:table-cell>
                       			<fo:table-cell border-style="solid">
                           			<fo:block  keep-together="always" text-align="left" white-space-collapse="false">${(sachetDetails.get("closedReason"))}</fo:block>  
                       			</fo:table-cell>
						</fo:table-row>
						</#list>
						</#list>

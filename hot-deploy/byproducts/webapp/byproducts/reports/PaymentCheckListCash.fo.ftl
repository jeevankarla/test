                    ...
                    <fo:table-body> 
                     ...
                     <fo:table-row >
	                           <fo:table-cell >	
	                             ...
	                             <fo:table-cell >	
	                             <fo:block text-align="left" keep-together="always" font-size="12pt">Receipt</fo:block>    
                    ...
                    <fo:table-row><fo:table-cell><fo:block linefeed-treatment="preserve">&#xA;</fo:block></fo:table-cell></fo:table-row>    
	                         ...
	                         <fo:table-row >
	                            ...
	                            <#assign sno= 1>
			                     <#assign routeMktgTotal=0>
	                      		 <#list routeCheckListReportList as checkListReport>
	                         <fo:table-row >
	                            <fo:table-cell >	
	                      ...
	                      <fo:table-row >
	                       ...
	                       <fo:table-row >
	                        	...
	                        	<fo:table-cell  number-columns-spanned="2">	
	                            	<fo:block text-align="left" >GrandTotal:</fo:block>                             
	                            </fo:table-cell>
	                            <fo:table-cell >

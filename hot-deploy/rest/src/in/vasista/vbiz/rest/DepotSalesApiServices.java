...
public class DepotSalesApiServices {
	...
	public Map<String, Object> getWeaverDetails(
		...
		try {
			...
			Debug.log("======before========="+effectiveDate);
			if(effectiveDate==null){
				effectiveDate=UtilDateTime.nowTimestamp();
			}
			
			Debug.log("======afeter========="+effectiveDate);
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getWeaverIndents(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId,
				...
				@QueryParam("estimatedDeliveryDate") Timestamp orderDate,
				@QueryParam("estimatedDeliveryThruDate") Timestamp orderThruDate,
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getWeaverPayments(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId,
				@QueryParam("partyId") String partyIdFrom,
				@QueryParam("paymentId") String paramPaymentId
				) { 
	...
	public Map<String, Object> getProducts(
		...
		if(UtilValidate.isNotEmpty(salesDate)){
			dayBegin = salesDate;
		}
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getTransporters(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId
				) { 
	...
	@Path("/cancelIndent")        
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> cancelIndent(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId,
				@QueryParam("partyId") String partyId,
				@QueryParam("orderId") String orderId,
	...
	@Path("/getDepotStock")        
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getDepotStock(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId,
				@QueryParam("partyId") String partyId
				) { 
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> getIndentShipments(
				@QueryParam("login.username") String username,@QueryParam("login.password") String password,
				@QueryParam("tenantId") String tenantId,
				@QueryParam("orderId") String orderId
				) { 
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Map<String, Object> createBranchSalesIndent(
				...
				@FormParam("newContactMechId") String belowContactMechId,
				@FormParam("transporterId") String transporterId,
				@FormParam("manualQuota") String manualQuotaStr,
		...
		try{
			...
			svcResult = dispatcher.runSync("processBranchSalesOrder",processOrderContext);

...
function setUpRecentList(recentChnage) {
			...
			var grid;
			var data = [			
					{"id":"1","recordNumber":recentChnage['milkTransferId'], "Date":receiveDate , "unit":recentChnage['mccCode'], 
						"qty":recentChnage['recdQtyLtrs'],"tankerId":recentChnage['tankerId']
					}				
			];		
			...
			var columns = [
				...
				{id:"recordNumber", name:"Record Number", field:"recordNumber", width:80, minWidth:90, cssClass:"cell-title", sortable:false},
				{id:"unit", name:"unit", field:"unit", width:50, minWidth:50, cssClass:"cell-title", sortable:false},
				{id:"tankerId", name:"tanker", field:"tankerId", width:50, minWidth:50, cssClass:"cell-title", sortable:false},
		...
		$('#lastChange')
	  .html('<label>Last Change [made by  ' + recentChnage["lastModifiedByUserLogin"] +' ]</label>');
...
<div style="float: left;width: 90%; background:transparent;border: #F97103 solid 0.1em; valign:middle">
	...
	<div class="screenlet" background:transparent;border: #F97103 solid 0.1em;>      
      <div class="screenlet-title-bar">      
        <ul>
   			<li>
   				<a href="<@ofbizUrl>milkReceiptEntryList.txt?userLoginId=${userLogin.get("userLoginId")}&&all=Y</@ofbizUrl>" >All Check List</a>
            </li>  
   			<li>
   				<a href="<@ofbizUrl>milkReceiptEntryList.txt?userLoginId=${userLogin.get("userLoginId")}</@ofbizUrl>">My Check List</a>
            </li>                             
         </ul>
         <ul> <h3>Dispatch And Acknowledgement of Milk</h3></ul>
     </div>
    </div>
	          			...
	          			<table>
	        				...
	        				<tr><td align='left' >Despatch Time </td><td><input  name="sendTime" size="10" maxlength="4" type="text" id="sendTime" autocomplete="off"/></td>
                         	...
                         	<tr>
                         		...
                         		<input type="hidden" size="6" id="qtyKgsFlag" maxlength="6" name="qtyKgsFlag"  autocomplete="off" value="" />
                         		<input type="hidden" size="6" id="ACKfacilityId" maxlength="6" name="facilityId"  autocomplete="off" value="" />
                         		<input type="text" size="6" maxlength="6" name="mccCode" id="mccCode" autocomplete="on"/><span class="tooltip" id ="unitToolTip">none</span></td>
                   			</tr>
                   			<tr>
	        ...
	        <div class="grid-header h2" style="width:98%">
	        	...
	        	<td>
					 <table class="basic-table hover-bar h2" cellspacing="0">
						...
						<tr>
							<td>FC</td>
							<td><input type="text" size="8" maxlength="7" name="fcQtyLtrs" id="fcQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="fcFat" id="fcFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="fcSnf" id="fcSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="fcClr" id="fcClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="fcAcid" id="fcAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="fcTemp" id="fcTemp" autocomplete="off"/></td> 
						</tr>
						<tr><td>BC</td>
							<td><input type="text" size="8" maxlength="7" name="bcQtyLtrs" id="bcQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="bcFat" id="bcFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="bcSnf" id="bcSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="bcClr" id="bcClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="bcAcid" id="bcAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="bcTemp" id="bcTemp" autocomplete="off"/></td>
						</tr>
						<tr><td>MC</td>
							<td><input type="text" size="8" maxlength="7" name="mcQtyLtrs" id="mcQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="mcFat" id="mcFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="mcSnf" id="mcSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="mcClr" id="mcClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="mcAcid" id="mcAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="mcTemp" id="mcTemp" autocomplete="off"/></td>
						</tr>
	        	...
	        	<td>
					 <table class="basic-table hover-bar h2" cellspacing="0">
						...
						<tr>
							...
							<td><input type="text" size="8" maxlength="7" name="fcAckQtyLtrs" id="fcAckQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="fcAckFat" id="fcAckFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="fcAckSnf" id="fcAckSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="fcAckClr" id="fcAckClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="fcAckAcid" id="fcAckAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="fcAckTemp" id="fcAckTemp" autocomplete="off"/></td> 
						</tr>
						<tr><td nowrap="nowrap">BC ACK</td>
							<td><input type="text" size="8" maxlength="7" name="bcAckQtyLtrs" id="bcAckQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="bcAckFat" id="bcAckFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="bcAckSnf" id="bcAckSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="bcAckClr" id="bcAckClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="bcAckAcid" id="bcAckAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="bcAckTemp" id="bcAckTemp" autocomplete="off"/></td>
						</tr>
						<tr><td nowrap="nowrap">MC ACK</td>
							<td><input type="text" size="8" maxlength="7" name="mcAckQtyLtrs" id="mcAckQtyLtrs" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="mcAckFat" id="mcAckFat" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="mcAckSnf" id="mcAckSnf" autocomplete="off"/></td> 
							<td><input type="text" size="5" maxlength="6" name="mcAckClr" id="mcAckClr" autocomplete="off"/></td>
							<td><input type="text" size="5" maxlength="6" name="mcAckAcid" id="mcAckAcid" autocomplete="off"/></td>
							<td><input type="text" size="4" maxlength="6" name="mcAckTemp" id="mcAckTemp" autocomplete="off"/></td>
						</tr>
      ...
      <table>
      	<tr>
	      	...
	      	<div class='tabletext h1'>
	 			<input type="submit" align="right"  class="button" name="submitButton" id="submitEntry"/>      
	      		</div>
	      	</td>
      	</tr>
      </table>
...
<div id="div2" style="float: left;width: 50%;align:left; border: #F97103 solid 0.1em;" >
    <div>    	
 		<div class="grid-header" id="lastChange" style="width:100%">

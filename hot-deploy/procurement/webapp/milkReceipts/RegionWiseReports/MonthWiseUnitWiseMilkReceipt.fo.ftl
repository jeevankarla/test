...
<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
    ...
    ${setRequestAttribute("OUTPUT_FILENAME", "MonthWiseUnitWiseMilkReceipts.txt")}
			...
			<fo:table font-size="5pt">
				...
				<fo:table-body>
					<fo:table-row>
						...
						<fo:table-cell>
							<fo:block text-align="right" font-size="5pt" keep-together="always">%GE.GROWTH</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</fo:table-body>
			</fo:table>
      ...
      <fo:flow flow-name="xsl-region-body" font-family="Courier,monospace" font-size="5pt">
	 	<fo:block  font-size="5pt">
			<fo:table>
				...
				<fo:table-column column-width="35pt"/>
		        <fo:table-body>
		        	<#assign mccShedDetailList = currentShedFinalMap.entrySet()>
		        	<#list mccShedDetailList as mccShedWiseList>
		        		...
		        		<#if facility?has_content>
			        		...
			        		<#list currMonthKeyList as currMonthKey>
		            			...
		            			<#if (currentShedFinalMap.get(unitKey))?has_content>
		            				...
		            				<#if (tempValues.get(currMonthKey))?has_content>
			            				<#assign currentShedUnitValues = (tempValues.get(currMonthKey))>
				            			<#if currentShedUnitValues?has_content>
					            			<#assign shedCurrentMonthsQty=(currentShedFinalMap.get(unitKey).get(currMonthKey))>

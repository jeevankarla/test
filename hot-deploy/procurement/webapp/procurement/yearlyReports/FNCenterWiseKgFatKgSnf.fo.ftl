        ...
        <fo:layout-master-set>
            <fo:simple-page-master master-name="main" page-height="12in" page-width="15in" margin-top=".2in">
                ...
                <fo:region-after extent="1in"/>
                   ...
                   ${setRequestAttribute("OUTPUT_FILENAME", "FNCenterWise.txt")}
              </fo:layout-master-set>
...
<#else>         
     <#if finalMap?has_content>  
		<fo:page-sequence master-reference="main">
				...
				<fo:block text-align="left" white-space-collapse="false" keep-together="always">.	                                                                        MILK SHED NAME:  ${parameters.shedId}  		  	   						UNIT NAME:${facility.getString("facilityName")?if_exists}                         CENTER NAME:  ${centerFacility.getString("facilityName")?if_exists}                     </fo:block>
						 		...
						 		<fo:table-column column-width="15pt"/>
           						...
           						<fo:table-body>                   						
                			 		...
                			 		<#assign thruDate = Static["org.ofbiz.base.util.UtilDateTime"].toDateString(customTimePeriod.thruDate, "MMMdd yyyy")/>	
           								<fo:table-cell>
           									<fo:block keep-together="always" font-size="5pt" text-align="left">${fromDate}</fo:block>
           								</fo:table-cell>
           								<fo:table-cell>
												...
												<fo:table>          															
													...
													<fo:table-body>
														<fo:table-row>
															...
															<fo:table-cell>           																	 																		
																<fo:block font-size="5pt" text-indent="40pt" text-align="right">${Kgs?if_exists?string("##0.0")}</fo:block>     																	
															</fo:table-cell>
															<fo:table-cell>          
															...
															<fo:table-cell>          
																...
																<fo:table-cell>          
																	<fo:block font-size="4pt" text-align="right"><#if Kgs !=0>${((KgFat*100)/Kgs)?if_exists?string("##0.0")}<#else>0.0</#if></fo:block>     																	
																</fo:table-cell>
																<fo:table-cell>          
														...
														<#list monthTotalEntries as month> 
															<#if  month.getKey() =="TOT">
																...
																<fo:table-cell>          
																	<fo:block font-size="4pt" text-align="right">${mixKgSnf?if_exists?string("##0.000")}</fo:block>     																	
																</fo:table-cell>
																<fo:table-cell>          
																	<fo:block font-size="4pt" text-align="right">${(mixKgFat+mixKgSnf)?if_exists?string("##0.000")}</fo:block>     																	
																</fo:table-cell>
																<fo:table-cell>          
                   				...
                   				<fo:table-body>
                   					...
                   					<#list procurementProductList as procProducts>
										 ...
										 <#assign totKgSnf = (tot.getValue().get("kgSnf"))>       							   						
                   						...
                   						<fo:table-cell>
                   							<fo:block font-size="4pt" text-align="right">${totKgSnf?if_exists?string("##0.000")}</fo:block>
                   						</fo:table-cell>
                   						<fo:table-cell>          
											<fo:block font-size="4.5pt" text-align="right">${(totKgFat+totKgSnf)?if_exists?string("##0.000")}</fo:block>     																	
										</fo:table-cell>
										<fo:table-cell>          

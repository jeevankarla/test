<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        <fo:layout-master-set>
            ...
            ${setRequestAttribute("OUTPUT_FILENAME", "Unitwise.txt")}
        </fo:layout-master-set>
						 		...
						 		<fo:table-column column-width="10pt"/>
           						...
           						<fo:table-body>                   						
           							<fo:table-row>
           								...
           								<fo:table-cell>
           									<fo:block keep-together="always" font-size="4pt" text-align="left"></fo:block>
           								</fo:table-cell>
           								<fo:table-cell>
											<fo:block>
												<fo:table>          															
                                                       ...
                                                       <fo:table-column column-width="52pt"/><!--kgs-->
                                                       <fo:table-column column-width="30pt"/>
                                                       <fo:table-column column-width="30pt"/>
                                                       <fo:table-column column-width="30pt"/>
                                                       ...
                                                       <fo:table-column column-width="45pt"/>
                                                       <fo:table-column column-width="30pt"/>
                                                       <fo:table-column column-width="36pt"/><!--mixKgFat-->
                                                       <fo:table-column column-width="38pt"/>
                                                       <fo:table-column column-width="35pt"/>
                                                       <fo:table-column column-width="21pt"/><!--ptc-->
													...
													<fo:table-body>
														<fo:table-row>
															...
															<fo:table-cell>          
																...
																<fo:table-cell>          
																	<fo:block font-size="4pt" text-align="right">${(KgFat+KgSnf)?if_exists?string("##0.000")}</fo:block>     																	
																</fo:table-cell>
																<fo:table-cell>          
         				...
         				<fo:block font-size="5pt">
        					<fo:table>
        						<#assign totals = totalMap.entrySet()>
                                   ...
                                   <fo:table-column column-width="38pt"/><!--BMkgfat-->
                                   <fo:table-column column-width="40pt"/>
                                   <fo:table-column column-width="35pt"/>
                                   <fo:table-column column-width="18pt"/>
                                   <fo:table-column column-width="20pt"/><!--kgs-->
                                   <fo:table-column column-width="45pt"/> 
                                   <fo:table-column column-width="35pt"/>
                                   <fo:table-column column-width="32pt"/>
                                   <fo:table-column column-width="32pt"/>

...
<#else>     
  <fo:page-sequence master-reference="main">
  		<fo:static-content flow-name="xsl-region-before">
            ...
            <fo:block text-align="left" keep-together="always" white-space-collapse="false" font-size="7pt">S.No  	   Date    	   Qty Ltrs      Vehicle No      Fat%       Snf%      Qty(Kgs)     Kg.Fat      Kg.Snf</fo:block>
            <fo:block font-size="8pt">----------------------------------------------------------------------------------------------------------------------</fo:block>
 		</fo:static-content>
      <fo:flow flow-name="xsl-region-body" font-family="Courier,monospace">
		...
		<fo:table width="295pt" table-layout="fixed">
             ...
             <#assign dayWiseSales = dayWiseSalesMap>
                ...
                <fo:table-row>
                   <fo:table-cell>
                        	<fo:block text-align="left" font-size="4pt">${sno}</fo:block>
                   </fo:table-cell>
                   <fo:table-cell>
                        	<fo:block text-align="left" font-size="4pt">${dayWiseSales.get("date")?if_exists}</fo:block>
                   </fo:table-cell>
                    <fo:table-cell>
                        	<fo:block text-align="right" font-size="4pt">${dayWiseSales.get("qtyLtrs")?if_exists?string("##0.00")}</fo:block>
                   </fo:table-cell>
                    <fo:table-cell>
                        	<fo:block text-align="right"  font-size="4pt">${dayWiseSales.get("vehicleNo")?if_exists}</fo:block>
                   </fo:table-cell>
                   <fo:table-cell>
                        	 ...
                        	 <fo:table width="295pt" table-layout="fixed">
					             ...
					             <#list outputDayWiseList as outputDayWiseListMap>
					                ...
					                <fo:table-row>
				                  		 ...
				                  		 <fo:table-cell>
				                        	<fo:block text-align="left" font-size="4pt" font-weight="bold">CB</fo:block>
				                   		</fo:table-cell>
				                    	...
				                    	<fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${outputDayWiseSales.get("quantityLtrs")?if_exists?string("##0.00")}</fo:block>
				                   		</fo:table-cell>
				                    	<fo:table-cell>
				                        	<fo:block text-align="right"  font-size="4pt"></fo:block>
				                   		</fo:table-cell>
							 ...
							 <fo:table-column column-width="33pt"/>
					             ...
					             <#assign sno = sno + 1>
					                <fo:table-row>
				                  		 ...
				                  		 <fo:table-cell>
				                        	<fo:block text-align="left" font-size="4pt" font-weight="bold">Grand Total</fo:block>
				                   		</fo:table-cell>
				                    	<fo:table-cell>
				                    	...
				                    	<fo:table-cell>
				                   		...
				                   		<fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${totalQtyKgs?if_exists?string("##0.00")}</fo:block>
				                  	   </fo:table-cell>
				                   	   <fo:table-cell>
                             ...
                             <fo:table width="295pt" table-layout="fixed">
					             ...
					             <#assign sno = sno + 1>
					                <fo:table-row>
				                  		 ...
				                  		 <fo:table-cell>
				                        	<fo:block text-align="left" font-weight="bold">OB</fo:block>
				                   		</fo:table-cell>
				                    	<fo:table-cell>
                        	 ...
                        	 <fo:table width="295pt" table-layout="fixed">
					             ...
					             <#assign sno = sno + 1>
					                <fo:table-row>
				                  		 ...
				                  		 <fo:table-cell>
				                        	<fo:block text-align="left" font-weight="bold" font-size="4pt">Net Total</fo:block>
				                   		</fo:table-cell>
				                    	<fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${(totalQtyLtrs-totQtyLtrs)?if_exists?string("##0.00")}</fo:block>
				                   		</fo:table-cell>
				                    	<fo:table-cell>
				                        	<fo:block text-align="right"  font-size="4pt"></fo:block>
				                   		</fo:table-cell>
				                   		...
				                   		<fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${(totalQtyKgs-totQty)?if_exists?string("##0.00")}</fo:block>
				                  	   </fo:table-cell>
				                   	   <fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${(totalKgFat-totKgFat)?if_exists?string("##0.00")}</fo:block>
				                   	   </fo:table-cell>
				                      <fo:table-cell>
				                        	<fo:block text-align="right" font-size="4pt">${(totalKgSnf-totKgSnf)?if_exists?string("##0.00")}</fo:block>
				                      </fo:table-cell>
					               </fo:table-row>
					            </fo:table-body>
           				   </fo:table> 

...
<#escape x as x?xml>
    <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        ${setRequestAttribute("OUTPUT_FILENAME", "unitDayWiseKgFatAcc.txt")}
...
<#else>          
       ...
       <fo:page-sequence master-reference="main">
        <fo:static-content flow-name="xsl-region-before" font-family="Courier,monospace" >
            ...
            <fo:block text-align="left" white-space-collapse="false"  keep-together="always">&#160;               STATEMENT OF UNIT WISE ANALYSIS FOR LTS,KGS,KGFAT,KGSNF AND AVERAGE FAT, AVERAGE SNF  PAGE NO:<fo:page-number/></fo:block>
                    ...
                    <fo:block font-size="7pt">
                      ...
                      <fo:table-body>
                        ...
                        <fo:table-row>
                            ...
                            <fo:table-cell><fo:block text-align="right">${(dayWiseEntry.gKgFat)?if_exists?string("##0.000")}</fo:block>
                            </fo:table-cell>
                            ...
                            <fo:table-cell><fo:block text-align="right">${((dayWiseEntry.gKgFat)+((dayWiseEntry.sKgFat)))?if_exists?string("##0.000")}</fo:block>
                            </fo:table-cell>
                            <fo:table-cell><fo:block text-align="right">${((dayWiseEntry.kgSnf))?if_exists?string("##0.000")}</fo:block>
                            </fo:table-cell>
                        ...
                        <#assign printLine=1>
                          ...
                          <#if grandTotal.milkType != "TOT">
                            ...
                            <fo:table-row>
                                ...
                                <fo:table-cell><fo:block text-align="right">${(grandTotal.gKgFat)?if_exists?string("##0.000")}</fo:block>
                                </fo:table-cell>
                                ...
                                <fo:table-cell><fo:block text-align="right">${((grandTotal.gKgFat)+((grandTotal.sKgFat)))?if_exists?string("##0.000")}</fo:block>
                                </fo:table-cell>
                                <fo:table-cell><fo:block text-align="right">${((grandTotal.kgSnf))?if_exists?string("##0.000")}</fo:block>
                                </fo:table-cell>

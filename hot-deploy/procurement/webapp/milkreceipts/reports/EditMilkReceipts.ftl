...
<div class="screenlet">
	 <div class="screenlet-title-bar">
      <h3>Find Edit Milk Receipts</h3>
    </div>
    <div class="screenlet-body">
 		<form method="post" name="editMilkReceipts" id="editMilkReceipts" action="<@ofbizUrl>EditMilkReceipt</@ofbizUrl>">  
	          		...
	          		<tr>
	          			<table>
        					...
        					<tr>
	        					...
	        					<td><input  size="12" type="text" id="findFromDate" name="fromDate" <#if entryDate?has_content> value="${entryDate}" </#if>/></td>
	        				</tr>

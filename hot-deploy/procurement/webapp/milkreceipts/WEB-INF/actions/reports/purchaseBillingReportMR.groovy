...
periodCondList.add(EntityCondition.makeCondition("customTimePeriodId", EntityOperator.EQUALS , parameters.customTimePeriodId));
...
periodBilling = delegator.findList("PeriodBilling",periodCond , null, null, null, false );
if(UtilValidate.isNotEmpty(periodBilling)){
	...
	Map allUnionPartyBillMap =FastMap.newInstance();
	Map allUnionPartyNamesMap =FastMap.newInstance();
	...
	context.allUnionPartyBillMap=allUnionPartyBillMap;
	context.allUnionPartyNamesMap=allUnionPartyNamesMap;

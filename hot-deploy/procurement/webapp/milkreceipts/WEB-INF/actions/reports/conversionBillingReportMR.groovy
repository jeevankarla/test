...
milkConversionConditionList.add(EntityCondition.makeCondition("partyId", EntityOperator.EQUALS , partyId));
...
Map conversionProductMap = FastMap.newInstance();
	...
	Set productIdsSet = new HashSet(EntityUtil.getFieldListFromEntityList(milkTransferConversionList, "productId", false));
...
context.put("conversionProductMap",conversionProductMap);